...
OBJS="combat/Combat.o combat/CombatOrder.o Empire/Empire.o Empire/EmpireManager.o Empire/ResourcePool.o network/Message.o network/MessageQueue.o network/Networking.o UI/StringTable.o UI/ShaderProgram-human.o universe/Building.o universe/Condition.o universe/ConditionParser1.o universe/ConditionParser2.o universe/ConditionParser.o universe/Effect.o universe/EffectParser.o universe/Enums.o universe/Fleet.o universe/Meter.o universe/ParserUtil.o universe/Planet.o universe/PopCenter.o universe/Predicates.o universe/ResourceCenter.o universe/Ship.o universe/ShipDesign.o universe/Special.o universe/System.o universe/Tech.o universe/TopLevelParsers.o universe/UniverseObject.o universe/ValueRef.o universe/ValueRefParser.o util/DataTable.o util/GZStream.o util/MultiplayerCommon.o util/OptionsDB.o util/Order.o util/OrderSet.o util/Process.o util/Random.o util/SerializeUniverse.o util/SerializeMultiplayerCommon.o util/SerializeOrderSet.o util/SerializePathingEngine.o util/SerializeEmpire.o util/SitRepEntry.o util/VarText.o util/Version.o util/binreloc.o util/Directories.o util/XMLDoc.o log4cpp/src/Appender.o log4cpp/src/AppenderSkeleton.o log4cpp/src/BasicLayout.o log4cpp/src/Category.o log4cpp/src/CategoryStream.o log4cpp/src/Configurator.o log4cpp/src/FactoryParams.o log4cpp/src/FileAppender.o log4cpp/src/HierarchyMaintainer.o log4cpp/src/LayoutAppender.o log4cpp/src/Localtime.o log4cpp/src/LoggingEvent.o log4cpp/src/NDC.o log4cpp/src/PatternLayout.o log4cpp/src/Priority.o log4cpp/src/StringUtil.o log4cpp/src/TimeStamp.o log4cpp/src/PThreads.o client/ClientApp-human.o client/ClientFSMEvents-human.o client/human/HumanClientFSM-human.o client/human/HumanClientApp-human.o client/human/chmain-human.o network/ClientNetworking-human.o UI/About-human.o UI/BuildDesignatorWnd-human.o UI/ChatWnd-human.o UI/ClientUI-human.o UI/CUIControls-human.o UI/CUIDrawUtil-human.o UI/CUIStyle-human.o UI/CUIWnd-human.o UI/FleetButton-human.o UI/FleetWnd-human.o UI/GalaxySetupWnd-human.o UI/InGameMenu-human.o UI/InfoPanels-human.o UI/IntroScreen-human.o UI/LinkText-human.o UI/CollisionMeshConverter-human.o UI/CombatSetupWnd-human.o UI/CombatWnd-human.o UI/MapWnd-human.o UI/MultiplayerLobbyWnd-human.o UI/OptionsWnd-human.o UI/DesignWnd-human.o UI/ProductionWnd-human.o UI/QueueListBox-human.o UI/ResearchWnd-human.o UI/ServerConnectWnd-human.o UI/SidePanel-human.o UI/SitRepPanel-human.o UI/Sound-human.o UI/SystemIcon-human.o UI/TechTreeWnd-human.o UI/TurnProgressWnd-human.o universe/Universe-human.o util/AppInterface-human.o UI/EncyclopediaDetailPanel-human.o UI/PagedGeometry/*.o combat/OpenSteer/*.o util/Math.o UI/CombatCamera-human.o"
...
if ! \
    ...
    -Wl,--as-needed \
    -Wl,--start-group \
    combat/Combat.o Empire/Empire.o Empire/EmpireManager.o Empire/ResourcePool.o network/Message.o network/MessageQueue.o network/Networking.o network/boost/error_code.o UI/StringTable.o universe/Building.o universe/Condition.o universe/ConditionParser1.o universe/ConditionParser2.o universe/ConditionParser.o universe/Effect.o universe/EffectParser.o universe/Enums.o universe/Fleet.o universe/Meter.o universe/ParserUtil.o universe/Planet.o universe/PopCenter.o universe/Predicates.o universe/ResourceCenter.o universe/Ship.o universe/ShipDesign.o universe/Special.o universe/System.o universe/Tech.o universe/TopLevelParsers.o universe/UniverseObject.o universe/ValueRef.o universe/ValueRefParser.o util/DataTable.o util/GZStream.o util/MultiplayerCommon.o util/OptionsDB.o util/Order.o util/OrderSet.o util/Process.o util/Random.o util/SerializeUniverse.o util/SitRepEntry.o util/VarText.o util/Version.o util/binreloc.o util/Directories.o util/XMLDoc.o client/ClientApp-ai.o client/ClientFSMEvents-ai.o client/AI/AIClientApp-ai.o client/AI/camain-ai.o network/ClientNetworking-ai.o universe/Universe-ai.o util/AppInterface-ai.o AI/AIInterface-ai.o AI/PythonAI-ai.o python/PythonEnumWrapper-ai.o python/PythonUniverseWrapper-ai.o python/PythonEmpireWrapper-ai.o python/PythonLoggingWrapper-ai.o \
    log4cpp/src/*.o \
    -LGG -L/usr/lib -L/usr/lib/python2.5/config \
    -static-libgcc  \
    -Wl,-static \
