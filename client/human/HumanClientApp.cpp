...
namespace {
    ...
    void AddOptions(OptionsDB& db) {
        ...
        Hotkey::AddHotkey("exit", UserStringNop("HOTKEY_EXIT"), GG::GGK_q, GG::MOD_KEY_CTRL);
        Hotkey::AddHotkey("quit", UserStringNop("HOTKEY_QUIT"), GG::GGK_F4, GG::MOD_KEY_NONE);
        Hotkey::AddHotkey("fullscreen", UserStringNop("HOTKEY_FULLSCREEN"), GG::GGK_F5, GG::MOD_KEY_NONE);
