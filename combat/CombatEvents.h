...
struct FO_COMMON_API IncapacitationsEvent : public CombatEvent {
    [[nodiscard]] constexpr IncapacitationsEvent() noexcept = default;
    [[nodiscard]] constexpr explicit IncapacitationsEvent(UniverseObjectType objects_type_) noexcept :
...
/** Aggregates all the fighter on fighter combat for one bout.*/
...
struct FO_COMMON_API FighterLaunchesEvent : public CombatEvent {
    [[nodiscard]] constexpr FighterLaunchesEvent() noexcept = default;
