...
float ShipHull::ProductionCost(EmpireID empire_id, UniverseObjectID location_id,
...
int ShipHull::ProductionTime(EmpireID empire_id, UniverseObjectID location_id,
                             const ScriptingContext& parent_context, int in_design_id) const
{
