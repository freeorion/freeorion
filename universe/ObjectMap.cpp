...
namespace ObjectMapPredicateTypeTraits {
    ...
    invokable, is_visitor, is_int_range, invokable_on_int, is_sorted
    */
    constexpr auto fsiv = ObjectMap::CheckTypes<Ship, std::vector<int>>();
    static_assert(fsiv == std::array{false, false, false, false, false, false, false, false, false, false, true, false, false});

    constexpr auto fcuifs = ObjectMap::CheckTypes<UniverseObject, boost::container::flat_set<int>>();
    static_assert(fcuifs == std::array{false, false, false, false, false, false, false, false, false, false, true, false, true});
    ...
    static_assert(lspbicsp == std::array{true, true, false, false, false, false, false, false, true, false, false, false, false});

    constexpr auto int_lambda = [](const int) -> bool { return false; };
    constexpr auto libi = ObjectMap::CheckTypes<Ship, decltype(int_lambda)>();
    static_assert(libi == std::array{false, false, false, false, false, false, false, false, true, false, false, true, false});
}
