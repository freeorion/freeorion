...
namespace GG {
    ...
    GG_ENUM_MAP_INSERT(METER_TARGET_HAPPINESS)
    ...
    GG_ENUM_MAP_INSERT(METER_MAX_REBEL_TROOPS)
    ...
    GG_ENUM_MAP_INSERT(METER_HAPPINESS)
    ...
    GG_ENUM_MAP_INSERT(METER_REBEL_TROOPS)
