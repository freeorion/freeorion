...
public:
    Fighter(EmpireID empire_id, UniverseObjectID launched_from_id, const std::string& species_name,
    ...
    [[nodiscard]] auto  LaunchedFrom() const noexcept { return m_launched_from_id; }
...
private:
    ...
    UniverseObjectID              m_launched_from_id = INVALID_OBJECT_ID; // from what object (ship?) was this fighter launched
