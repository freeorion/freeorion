...
Fighter::Fighter(int empire_id, int launched_from_id, const std::string& species_name, float damage, const focs::Condition* combat_targets) :
    UniverseObject(),
    m_damage(damage),
...
const focs::Condition* Fighter::CombatTargets() const
