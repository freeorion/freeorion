...
public:
    ...
    std::string                     AutoGeneratedDescription() const;
...
FO_COMMON_API std::string AutoGeneratedDescription(const std::vector<boost::shared_ptr<Effect::EffectsGroup> >& effects_groups);
...
class FO_COMMON_API Effect::EffectBase {
public:
    virtual ~EffectBase();
