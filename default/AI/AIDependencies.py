...
# Do specifiy hull detection only if it is irregular.
# Organic growth has the structure (per_turn, maximum)
HULL_EFFECTS = {
    # Robotic line
    ...
    "SH_SENTIENT": {"REPAIR_PER_TURN": 2, "FUEL_PER_TURN": 0.2, "DETECTION": 50,
                    "ORGANIC_GROWTH": (1, 45), "STEALTH_MODIFIER": 20, "DETECTION": 20},
    # Energy Line
