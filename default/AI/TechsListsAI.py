...
researched next.
"""
# TODO: this whole module shouldn't exist. These informations belong into the
# data files or should be calculated by the AI scripts.
#
# AI can not currently add new building types to production queue
# AI can not currently design or build custom ships
# individual techs are to be removed from unusable list as AI programming
# progresses
