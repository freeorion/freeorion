...
from stub_generator.interface_inspector import ClassInfo, EnumInfo, FunctionInfo
...
def make_stub(classes: List[ClassInfo], enums: List[EnumInfo], functions: List[FunctionInfo], instances, result_path, classes_to_ignore: set):
    ...
    for instance in instances:
        ...
        if class_name in enums_names:
            ...
            continue
        try:
            class_attrs = classes_map[class_name].attributes
        except KeyError:
