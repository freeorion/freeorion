...
Public functions:
    ...
    assert_content  - helper function to verify the decoded content of a class matches the expectation
...
from _definitions import CanNotSaveGameException, InvalidSaveGameException, assert_content
