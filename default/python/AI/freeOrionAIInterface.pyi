...
class empire:
    ...
    @property
    def resourceSupplyGroups(self) -> IntSetSet: ...
    @property
...
class species:
    ...
    def description(self) -> str: ...
    @property
    def dislikes(self) -> StringVec: ...
    @property
    def foci(self) -> StringVec: ...
    @property
    def homeworlds(self) -> IntSet: ...
    @property
    def likes(self) -> StringVec: ...
    @property
    def name(self) -> str: ...
    @property
...
def getTechCategories() -> StringVec:
    """
