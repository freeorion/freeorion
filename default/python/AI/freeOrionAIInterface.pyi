...
class empire:
    ...
    @property
    def categoriesSlotPolicies(self) -> Dict[str, Dict[int, str]]: ...
    @property
    ...
    @property
    def emptyPolicySlots(self) -> Dict[str, int]: ...
    @property
    ...
    def name(self) -> str: ...
    @property
    def planetsWithAllocatedPP(self) -> Dict[Set[int], float]: ...
    @property
    def planetsWithAvailablePP(self) -> Dict[Set[int], float]: ...
    @property
    ...
    @property
    def systemSupplyRanges(self) -> Dict[int, float]: ...
    @property
    def totalPolicySlots(self) -> Dict[str, int]: ...
    @property
    def totalShipsOwned(self) -> int: ...
    @property
    def turnsPoliciesAdopted(self) -> Dict[str, int]: ...
    @property
    def won(self) -> bool: ...
...
class productionQueue:
    @property
    def allocatedPP(self) -> Dict[Set[int], float]: ...
    @property
    def empireID(self) -> EmpireId: ...
    @property
    def empty(self) -> bool: ...
...
class universe:
    @property
    def allObjectIDs(self) -> Sequence[int]: ...
    @property
    ...
    def getSystemNeighborsMap(self, number1: int, number2: int) -> Dict[int, float]: ...
    def getVisibility(self, number1: int, number2: int) -> visibility: ...
    def getVisibilityTurnsMap(self, number1: int, number2: int) -> Dict[visibility, int]: ...
...
class ship(universeObject):
    ...
    def orderedScrapped(self) -> bool: ...
    @property
    def partMeters(self) -> Dict[shipPart, meter]: ...
    @property
    def producedByEmpireID(self) -> int: ...
    @property
    def speciesName(self) -> SpeciesName: ...
