...
class empire:
    ...
    @property
    def availableBuildingTypes(self) -> Vec[str]: ...
    @property
    def availablePolicies(self) -> Set[str]: ...
    @property
    def availableShipDesigns(self) -> Set[int]: ...
    @property
    def availableShipHulls(self) -> Vec[str]: ...
    @property
    def availableShipParts(self) -> Vec[str]: ...
    @property
...
class tech:
    ...
    def name(self) -> str: ...
    @property
    def prerequisites(self) -> Vec[str]: ...
    @property
    def shortDescription(self) -> str: ...
    @property
    def unlockedItems(self) -> Vec[UnlockableItem]: ...
    @property
    def unlockedTechs(self) -> Vec[str]: ...
...
class planet(universeObject):
    ...
    @property
    def availableFoci(self) -> Vec[str]: ...
    @property
    def buildingIDs(self) -> Vec[BuildingId]: ...
    @property
