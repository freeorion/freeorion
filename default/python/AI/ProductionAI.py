...
import PriorityAI
import ShipDesignAI
from AIDependencies import INVALID_ID, GRO_GAIA_TRANS, GRO_TERRAFORM
...
def generate_production_orders():
    ...
    if tech_is_complete(GRO_GAIA_TRANS):
        terraformers = ["BLD_GAIA_TRANS", "BLD_TERRAFORM"]
    elif tech_is_complete(GRO_TERRAFORM):
        terraformers = ["BLD_TERRAFORM"]
    else:
        terraformers = []
    if terraformers:
