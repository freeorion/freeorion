...
class ShipDesigner:
    ...
    def __init__(self):
        ...
        self.additional_specifications = AdditionalSpecifications(fo.currentTurn(), get_aistate().get_standard_enemy())
    ...
    def add_design(self, verbose: bool = True):
        ...
        reference_name = build_reference_name(self.hull.name, self.partnames)  # "Hull-Part1-Part2-Part3-Part4"
