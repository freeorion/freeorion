...
CRYONIC_COLONY_POD_COST = 120
OUTPOST_POD_COST = 50  # TODO Query directly from part
COLONY_POD_TURNS_TO_BUILD = 8
CRYONIC_COLONY_POD_TURNS_TO_BUILD = 10
...
LRN_ARTIF_MINDS_2 = "LRN_ARTIF_MINDS"
...
HULL_EFFECTS = {
    ...
    "SH_ORGANIC": {
        ...
        FUEL_PER_TURN: 0.2,
        DETECTION: 10,
        ORGANIC_GROWTH: (0.2 * SHIP_STRUCTURE_FACTOR, 5 * SHIP_STRUCTURE_FACTOR),
    },
    "SH_ENDOMORPHIC": {
        DETECTION: 50,
