...
HULL_EFFECTS = {
    ...
    "SH_ENDOMORPHIC": {
        DETECTION: 50,
        ORGANIC_GROWTH: (0.5 * SHIP_STRUCTURE_FACTOR, 10 * SHIP_STRUCTURE_FACTOR),
    },
    "SH_SYMBIOTIC": {
        REPAIR_PER_TURN: 2 * SHIP_STRUCTURE_FACTOR,
        FUEL_PER_TURN: 0.2,
        DETECTION: 50,
        ORGANIC_GROWTH: (0.4 * SHIP_STRUCTURE_FACTOR, 16 * SHIP_STRUCTURE_FACTOR),
    },
    "SH_PROTOPLASMIC": {
        REPAIR_PER_TURN: 2 * SHIP_STRUCTURE_FACTOR,
        FUEL_PER_TURN: 0.2,
    ...
    "SH_RAVENOUS": {
        DETECTION: 75,
        ORGANIC_GROWTH: (0.75 * SHIP_STRUCTURE_FACTOR, 36 * SHIP_STRUCTURE_FACTOR),
    },
    "SH_BIOADAPTIVE": {
        REPAIR_PER_TURN: (STRUCTURE, 1),
        FUEL_PER_TURN: 0.2,
        DETECTION: 75,
        ORGANIC_GROWTH: (0.5 * SHIP_STRUCTURE_FACTOR, get_named_real("SH_BIOADAPTIVE_GROWTH_STRUCTURE")),
    },
    "SH_SENTIENT": {
        REPAIR_PER_TURN: 2 * SHIP_STRUCTURE_FACTOR,
        FUEL_PER_TURN: 0.2,
        DETECTION: 70,
        ORGANIC_GROWTH: (1 * SHIP_STRUCTURE_FACTOR, 60 * SHIP_STRUCTURE_FACTOR),
        STEALTH_MODIFIER: 20,
    },
    # Energy Line
    "SH_SOLAR": {
