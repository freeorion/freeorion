class AdditionalSpecifications:
    ...
    def __init__(self, current_turn: int, standard_enemy: "ShipCombatStats"):  # noqa: F821
        ...
        self.enemy = None
        self._update_enemy(standard_enemy)

    def _update_enemy(self, enemy: "ShipCombatStats"):  # noqa: F821
