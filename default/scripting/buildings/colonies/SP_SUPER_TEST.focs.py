...
BuildingType(  # pyright: ignore[unbound-name]
    ...
    * MaxOf(
    ...
    species="SP_SUPER_TEST",
    tags=["SP_SUPER_TEST"],
    location=Planet()
    & OwnedBy(empire=Source.Owner)
    & Population(high=0)
    & ~Planet(environment=[Uninhabitable], species="SP_SUPER_TEST")
    ...
    & (GameRule(type=int, name="RULE_ENABLE_SUPER_TESTER") > 0),
