    ...
    * MaxOf(
        ...
        + (
            Statistic(
                ...
                & (
                    (HasSpecies(name=["SP_KILANDOW"]) & Population(low=MIN_RECOLONIZING_SIZE) & Happiness(low=5))
                    | (
    ...
    & OwnedBy(empire=Source.Owner)
    & Population(high=0)
    & ~Planet(environment=[Uninhabitable], species="SP_KILANDOW")
