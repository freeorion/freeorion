...
from focs._effects import Destroy, EffectsGroup, GenerateSitRepMessage, SetOwner, SetSpecialCapacity, SetVisibility
from focs._enums import AllyOf, DestroyOnCapture, Partial
