...
Tech(
    ...
    effectsgroups=EG_SYSTEM_MINES(
        NamedReal(name="SYSTEM_MINES_1", value=2 * SYSTEM_MINES_DAMAGE_FACTOR), 75, "EMPIRE"
...
Tech(
    ...
    effectsgroups=EG_SYSTEM_MINES(NamedReal(name="SYSTEM_MINES_2", value=6 * SYSTEM_MINES_DAMAGE_FACTOR), 65, "EMPIRE"),
    graphic="icons/tech/system_defense_mines.png",
)
...
Tech(
    ...
    effectsgroups=EG_SYSTEM_MINES(
        NamedReal(name="SYSTEM_MINES_3", value=14 * SYSTEM_MINES_DAMAGE_FACTOR), 60, "EMPIRE"
    ),
    graphic="icons/tech/system_defense_mines.png",
)
