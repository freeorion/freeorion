...
@overload
def OneOf(type_: str, *args: _Visibility) -> int: ...
@overload
def OneOf(type_: str, *args: _PlanetType) -> int: ...
@overload
def OneOf(type_: str, *args: _PlanetSize) -> int: ...
@overload
def OneOf(type_: str, *args: _StarType) -> int: ...
@overload
def MinOf(type_: type[_T], *args: _args_type) -> _T: ...
@overload
def MinOf(type_: str, *args: _Visibility) -> int: ...
@overload
def MinOf(type_: str, *args: _PlanetType) -> int: ...
@overload
def MinOf(type_: str, *args: _PlanetSize) -> int: ...
@overload
def MinOf(type_: str, *args: _StarType) -> int: ...
@overload
def MaxOf(type_: type[_T], *args: _args_type) -> _T: ...
@overload
def MaxOf(type_: str, *args: _Visibility) -> int: ...
@overload
def MaxOf(type_: str, *args: _PlanetType) -> int: ...
@overload
def MaxOf(type_: str, *args: _PlanetSize) -> int: ...
@overload
def MaxOf(type_: str, *args: _StarType) -> int: ...
...
def IsBuilding(*, name: str | _BuildingType | list[str | _BuildingType] | None = None) -> _Condition: ...
