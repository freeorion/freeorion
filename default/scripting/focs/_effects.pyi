...
def BuildingTypesProduced(*, empire: _EmpireId) -> _Condition: ...
def BuildingTypesScrapped(*, empire: _EmpireId) -> _Condition: ...
def ShipDesignsLost(*, empire: _EmpireId) -> _Condition: ...
def ShipDesignsProduced(*, empire: _EmpireId) -> _Condition: ...
def ShipDesignsScrapped(*, empire: _EmpireId) -> _Condition: ...
def SpeciesPlanetsBombed(*, empire: _EmpireId) -> _Condition: ...
def SpeciesPlanetsDepoped(*, empire: _EmpireId) -> _Condition: ...
def SpeciesPlanetsInvaded(*, empire: _EmpireId) -> _Condition: ...
