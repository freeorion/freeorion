...
def Population(low: _NumberType = _SOME_FLOAT, high: _NumberType = _SOME_FLOAT) -> _Scope: ...
def TargetPopulation(*, low: _NumberType = _SOME_FLOAT, high: _NumberType = _SOME_FLOAT) -> _Scope: ...
def SpeciesLikes(name: _Focus) -> _Scope: ...
def SpeciesDislikes(name: _Focus) -> _Scope: ...
...
def InSystem(id: _SystemID | None = None) -> _Scope: ...
...
def Structure(high: _FloatValue = _FloatValue()) -> _Scope: ...
def DesignHasPart(*, name: str, low: int = _SOME_INT, high: int = _SOME_INT) -> _Scope: ...
def EmpireHasAdoptedPolicy(*, name: str, empire: _Empire = _Empire()) -> _Scope: ...
...
def SetEmpireMeter(empire: _Empire, meter: str, value: _NumberType) -> _Effect: ...
