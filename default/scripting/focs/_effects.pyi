...
def Statistic(
    type_: type[_T], aggregator: _Aggregator, value: _Value[_T] | _FloatType | _StringType, condition: _Condition
) -> _Value[_T]: ...
...
def HasSpecies(*, name: list[_StringType] = []) -> _Condition: ...
...
def SetSpeciesTargetOpinion(*, species: _SpeciesValue, empire: _Empire, opinion: _FloatType) -> _Effect: ...
def SetSpeciesOpinion(*, species: _SpeciesValue, empire: _Empire, opinion: _FloatType) -> _Effect: ...
