...
def HasStarlane(condition: _Condition) -> _Condition: ...
def HasDesign(name: _StringParam) -> _Condition: ...
def StarlaneToWouldCrossExistingStarlane(condition: _Condition) -> _Condition: ...
def StarlaneToWouldBeAngularlyCloseToExistingStarlane(condition: _Condition, maxdotprod: float) -> _Condition: ...
def StarlaneToWouldBeCloseToObject(distance: float, condition: _Condition, closeto: _Condition) -> _Condition: ...
