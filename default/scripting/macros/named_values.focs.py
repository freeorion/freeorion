...
from macros.upkeep_pre import DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_FOR_ARG1_VREF_STATIC
...
# UI (and AI) for design simplicity policy
DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_AAA = DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_FOR_ARG1_VREF_STATIC(2)
DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_AA = DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_FOR_ARG1_VREF_STATIC(3)
DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_A = DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_FOR_ARG1_VREF_STATIC(4)
DESIGN_SIMPLICITY_COMPLEXITY_FACTOR = DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_FOR_ARG1_VREF_STATIC(5)
NamedReal(
    name="PLC_DESIGN_SIMPLICITY_MAX_REDUCTION_PERCENT",
    value=Round(float, (1.0 - DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_AAA) * 100),
)
NamedReal(name="PLC_DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_AAA", value=DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_AAA)
NamedReal(name="PLC_DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_AA", value=DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_AA)
NamedReal(name="PLC_DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_A", value=DESIGN_SIMPLICITY_COMPLEXITY_FACTOR_A)
NamedReal(name="PLC_DESIGN_SIMPLICITY_COMPLEXITY_FACTOR", value=DESIGN_SIMPLICITY_COMPLEXITY_FACTOR)
# design simplicity depends on upkeep macros
