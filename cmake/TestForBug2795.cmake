...
#
# G++ 10.0.1 had a regression bug, which causes boost::serialization to fail to
# compile because the underlying type of a strong typedef template did not
# expose its ++/-- post operators.
#
# For more details see: https://github.com/freeorion/freeorion/issues/2795
# https://github.com/boostorg/serialization/issues/192
# https://gcc.gnu.org/bugzilla/show_bug.cgi?id=94190

include(CheckCXXSourceCompiles)

# Enforce compiler to be invoked with C locale to ensure non-localized error
# messages.
