  ...
  if(Boost_INCLUDE_DIR)
    if(Boost_${basename}_LIBRARY_DEBUG AND Boost_${basename}_LIBRARY_RELEASE)
      ...
      if(_isMultiConfig OR CMAKE_BUILD_TYPE)
        set(Boost_${basename}_LIBRARY optimized ${Boost_${basename}_LIBRARY_RELEASE} debug
      ...
      set(Boost_${basename}_LIBRARIES optimized ${Boost_${basename}_LIBRARY_RELEASE} debug
                                      ${Boost_${basename}_LIBRARY_DEBUG}
      )
    endif()
...
macro(_Boost_FIND_LIBRARY var build_type)
  ...
  if(Boost_LIBRARY_DIR_${build_type})
    set(_boost_LIBRARY_SEARCH_DIRS_${build_type} ${Boost_LIBRARY_DIR_${build_type}} NO_DEFAULT_PATH
...
function(_Boost_COMPILER_DUMPVERSION _OUTPUT_VERSION _OUTPUT_VERSION_MAJOR _OUTPUT_VERSION_MINOR)
  ...
  string(REGEX REPLACE "([0-9]+)\\.([0-9]+)(\\.[0-9]+)?" "\\2" _boost_COMPILER_VERSION_MINOR
                       "${CMAKE_CXX_COMPILER_VERSION}"
  )
...
function(_Boost_CHECK_SPELLING _var)
  if(${_var})
    ...
    message(
      FATAL_ERROR "ERROR: ${_var} is not the correct spelling.  The proper spelling is ${_var_UC}."
    )
  endif()
endfunction()
...
function(_Boost_GUESS_COMPILER_PREFIX _ret)
  ...
  elseif("x${CMAKE_CXX_COMPILER_ID}" STREQUAL "xMSVC" OR "x${CMAKE_CXX_SIMULATE_ID}" STREQUAL
                                                         "xMSVC"
  )
  ...
  elseif(MINGW)
    if(${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION} VERSION_LESS 1.34)
      ...
      _boost_compiler_dumpversion(
        _boost_COMPILER_VERSION _boost_COMPILER_VERSION_MAJOR _boost_COMPILER_VERSION_MINOR
      )
  ...
  elseif(UNIX)
    ...
    if(NOT Boost_VERSION VERSION_LESS 106900)
      ...
      elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND _boost_COMPILER_VERSION_MAJOR
                                                        VERSION_GREATER 3
      )
        set(_boost_COMPILER_VERSION "${_boost_COMPILER_VERSION_MAJOR}")
      endif()
  ...
  while(_boost_unprocessed_components)
    ...
    foreach(component ${_boost_unprocessed_components})
      ...
      foreach(componentdep ${_Boost_${uppercomponent}_DEPENDENCIES})
        if(NOT ("${componentdep}" IN_LIST _boost_processed_components OR "${componentdep}" IN_LIST
                                                                         _boost_new_components)
        )
...
if(NOT TARGET Boost::diagnostic_definitions)
  ...
  set_target_properties(
    Boost::dynamic_linking PROPERTIES INTERFACE_COMPILE_DEFINITIONS "BOOST_ALL_DYN_LINK"
  )
endif()
if(WIN32)
  ...
  set_target_properties(
    Boost::diagnostic_definitions PROPERTIES INTERFACE_COMPILE_DEFINITIONS "BOOST_LIB_DIAGNOSTIC"
  )
  set_target_properties(
    Boost::disable_autolinking PROPERTIES INTERFACE_COMPILE_DEFINITIONS "BOOST_ALL_NO_LIB"
  )
endif()
...
if(NOT Boost_INCLUDE_DIR)
  ...
  if(Boost_NO_SYSTEM_PATHS)
    ...
    list(APPEND _boost_INCLUDE_SEARCH_DIRS PATHS C:/boost/include C:/boost /sw/local/include)
  endif()
  ...
  foreach(_boost_VER ${_boost_TEST_VERSIONS})
    ...
    if(_boost_VER MATCHES "([0-9]+)\\.([0-9]+)\\.([0-9]+)")
      set(_boost_BOOSTIFIED_VERSION "${CMAKE_MATCH_1}_${CMAKE_MATCH_2}_${CMAKE_MATCH_3}")
    elseif(_boost_VER MATCHES "([0-9]+)\\.([0-9]+)")
      set(_boost_BOOSTIFIED_VERSION "${CMAKE_MATCH_1}_${CMAKE_MATCH_2}")
    endif()

    list(APPEND _boost_PATH_SUFFIXES "boost-${_boost_BOOSTIFIED_VERSION}"
         "boost_${_boost_BOOSTIFIED_VERSION}" "boost/boost-${_boost_BOOSTIFIED_VERSION}"
...
if(DEFINED Boost_ARCHITECTURE)
  ...
  if(NOT "x${CMAKE_CXX_COMPILER_ARCHITECTURE_ID}" STREQUAL "x" AND NOT Boost_VERSION VERSION_LESS
                                                                   106600
  )
    ...
    elseif(CMAKE_CXX_COMPILER_ARCHITECTURE_ID STREQUAL "X86" OR CMAKE_CXX_COMPILER_ARCHITECTURE_ID
                                                                STREQUAL "x64"
    )
...
foreach(c DEBUG RELEASE)
  ...
  _boost_change_detect(
    _Boost_CHANGE_LIBDIR_${c} ${_Boost_VARS_DIR} ${_Boost_VARS_LIB_${c}} Boost_INCLUDE_DIR
  )
  ...
  if(Boost_LIBRARY_DIR_${c})
    ...
    if(Boost_NO_SYSTEM_PATHS)
      ...
      list(APPEND _boost_LIBRARY_SEARCH_DIRS_${c} PATHS C:/boost/lib C:/boost /sw/local/lib)
    endif()
  endif()
endforeach()
...
if(Boost_FOUND)
  ...
  if(NOT TARGET Boost::boost)
    ...
    if(Boost_INCLUDE_DIRS)
      set_target_properties(
        Boost::boost PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${Boost_INCLUDE_DIRS}"
      )
    endif()
  endif()
  ...
  foreach(COMPONENT ${Boost_FIND_COMPONENTS})
    if(_Boost_IMPORTED_TARGETS AND NOT TARGET Boost::${COMPONENT})
      ...
      if(Boost_${UPPERCOMPONENT}_FOUND)
        ...
        if(Boost_INCLUDE_DIRS)
          set_target_properties(
            Boost::${COMPONENT} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${Boost_INCLUDE_DIRS}"
          )
        endif()
        if(EXISTS "${Boost_${UPPERCOMPONENT}_LIBRARY}")
          set_target_properties(
            Boost::${COMPONENT} PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
        ...
        if(_Boost_${UPPERCOMPONENT}_DEPENDENCIES)
          ...
          set_target_properties(
            Boost::${COMPONENT} PROPERTIES INTERFACE_LINK_LIBRARIES
                                           "${_Boost_${UPPERCOMPONENT}_TARGET_DEPENDENCIES}"
          )
        endif()
        if(_Boost_${UPPERCOMPONENT}_COMPILER_FEATURES)
          set_target_properties(
            Boost::${COMPONENT} PROPERTIES INTERFACE_COMPILE_FEATURES
                                           "${_Boost_${UPPERCOMPONENT}_COMPILER_FEATURES}"
          )
        endif()
      endif()
