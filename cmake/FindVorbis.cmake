...
# ::
#
# Vorbis                 - The vorbis decoder library. VorbisEnc              -
# The vorbis encoder library. VorbisFile             - The vorbis file library.
#
# IMPORTED Targets
# ^^^^^^^^^^^^^^^^
#
...
# ::
#
# ``Vorbis::Vorbis``     - The vorbis decoder library. ``Vorbis::VorbisEnc``  -
# The vorbis encoder library. ``Vorbis::VorbisFile`` - The vorbis file library.
#
# Result Variables
# ^^^^^^^^^^^^^^^^
#
...
# ::
#
# VORBIS_INCLUDE_DIRS    - where to find codec.h, etc. VORBIS_LIBRARIES       -
# List of libraries when using vorbis, vorbisenc and vorbisfile. VORBIS_FOUND -
# True if vorbis found.
#
# Hints ^^^^^
#
# A user may set ``VORBISDIR`` environment to a ogg installation root to tell
...
# Normal search.
set(_VORBIS_SEARCH_NORMAL PATH "")
...
foreach(_component ${_components})
  ...
  if(NOT ${_component}_LIBRARY)
    foreach(search ${_VORBIS_SEARCHES})
      find_library(
        ${_component}_LIBRARY_RELEASE
        NAMES ${${_component}_NAMES} ${${search}}
        PATH_SUFFIXES lib
      )
      find_library(
        ${_component}_LIBRARY_DEBUG
        NAMES ${${_component}_NAMES_DEBUG} ${${search}}
        PATH_SUFFIXES lib
      )
    endforeach()
...
# handle the QUIETLY and REQUIRED argument and set VORBIS_FOUND to TRUE if all
...
if(VORBIS_FOUND)
  ...
  if(NOT TARGET Vorbis::Vorbis)
    ...
    set_target_properties(
      Vorbis::Vorbis PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${VORBIS_INCLUDE_DIRS}"
    )
    ...
    if(VORBIS_LIBRARY_RELEASE)
      ...
      set_target_properties(
        Vorbis::Vorbis PROPERTIES IMPORTED_LOCATION_RELEASE "${VORBIS_LIBRARY_RELEASE}"
      )
    endif()
    ...
    if(VORBIS_LIBRARY_DEBUG)
      ...
      set_target_properties(
        Vorbis::Vorbis PROPERTIES IMPORTED_LOCATION_DEBUG "${VORBIS_LIBRARY_DEBUG}"
      )
    endif()
    ...
    if(NOT VORBIS_LIBRARY_RELEASE AND NOT VORBIS_LIBRARY_DEBUG)
      set_property(
        TARGET Vorbis::Vorbis
        APPEND
        PROPERTY IMPORTED_LOCATION "${VORBIS_LIBRARY}"
      )
    endif()
  endif()
  ...
  if(NOT TARGET Vorbis::VorbisEnc)
    ...
    set_target_properties(
      Vorbis::VorbisEnc PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${VORBISENC_INCLUDE_DIRS}"
    )

    if(VORBISENC_LIBRARY_RELEASE)
      set_property(
        TARGET Vorbis::VorbisEnc
        APPEND
        PROPERTY IMPORTED_CONFIGURATIONS RELEASE
      )
      set_target_properties(
        Vorbis::VorbisEnc PROPERTIES IMPORTED_LOCATION_RELEASE "${VORBISENC_LIBRARY_RELEASE}"
      )
    endif()
    ...
    if(VORBISENC_LIBRARY_DEBUG)
      ...
      set_target_properties(
        Vorbis::VorbisEnc PROPERTIES IMPORTED_LOCATION_DEBUG "${VORBISENC_LIBRARY_DEBUG}"
      )
    endif()
    ...
    if(NOT VORBISENC_LIBRARY_RELEASE AND NOT VORBISENC_LIBRARY_DEBUG)
      set_property(
        TARGET Vorbis::VorbisEnc
        APPEND
        PROPERTY IMPORTED_LOCATION "${VORBISENC_LIBRARY}"
      )
    endif()
  ...
  if(NOT TARGET Vorbis::VorbisFile)
    ...
    set_target_properties(
      Vorbis::VorbisFile PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${VORBISFILE_INCLUDE_DIRS}"
    )
    ...
    if(VORBISFILE_LIBRARY_RELEASE)
      ...
      set_target_properties(
        Vorbis::VorbisFile PROPERTIES IMPORTED_LOCATION_RELEASE "${VORBISFILE_LIBRARY_RELEASE}"
      )
    endif()
    ...
    if(VORBISFILE_LIBRARY_DEBUG)
      ...
      set_target_properties(
        Vorbis::VorbisFile PROPERTIES IMPORTED_LOCATION_DEBUG "${VORBISFILE_LIBRARY_DEBUG}"
      )
    endif()
    ...
    if(NOT VORBISFILE_LIBRARY_RELEASE AND NOT VORBISFILE_LIBRARY_DEBUG)
      set_property(
        TARGET Vorbis::VorbisFile
        APPEND
        PROPERTY IMPORTED_LOCATION "${VORBISFILE_LIBRARY}"
      )
    endif()
