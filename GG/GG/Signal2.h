...
#define GG_SIGNALS_NUM_ARGS 2
#define GG_SIGNALS_SIGNAL_TEMPLATE_PARMS class A1, class A2
#define GG_SIGNALS_SIGNAL_TEMPLATE_ARGS A1, A2
#define GG_SIGNALS_SIGNAL_PARMS A1 a1, A2 a2
#define GG_SIGNALS_SIGNAL_ARGS a1, a2
#define GG_SIGNALS_BIND_ARGS _1, _2
