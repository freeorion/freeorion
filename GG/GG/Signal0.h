...
#define GG_SIGNALS_NUM_ARGS 0
#define GG_SIGNALS_SIGNAL_TEMPLATE_PARMS
#define GG_SIGNALS_SIGNAL_TEMPLATE_ARGS
#define GG_SIGNALS_SIGNAL_PARMS
#define GG_SIGNALS_SIGNAL_ARGS
#define GG_SIGNALS_BIND_ARGS
