...
#define GG_SIGNALS_NUM_ARGS 3
#define GG_SIGNALS_SIGNAL_TEMPLATE_PARMS class A1, class A2, class A3
#define GG_SIGNALS_SIGNAL_TEMPLATE_ARGS A1, A2, A3
#define GG_SIGNALS_SIGNAL_PARMS A1 a1, A2 a2, A3 a3
