...
{
    return Clr(
        static_cast<unsigned char>(static_cast<int>(clr.r / factor)),
        static_cast<unsigned char>(static_cast<int>(clr.g / factor)),
        static_cast<unsigned char>(static_cast<int>(clr.b / factor)),
        clr.a);
}
