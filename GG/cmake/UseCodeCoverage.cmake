...
#
# Copyright (C) 2016 Marcel Metz Copyright (C) 2017-2020 The FreeOrion Project
#
# Released under the GNU Lesser General Public License 2.1 or later. Some Rights
# Reserved.  See COPYING file or https://www.gnu.org/licenses/lgpl-2.1.txt
...
mark_as_advanced(
  ...
  CMAKE_SHARED_LINKER_FLAGS_COVERAGE CMAKE_ARCHIVE_LINKER_FLAGS_COVERAGE
)
...
if(CMAKE_CONFIGURATION_TYPES)
  ...
  set(CMAKE_CONFIGURATION_TYPES
      ...
      CACHE STRING "Available types of build" FORCE
  )
endif()

set(COVERAGE_REPORT_TYPE
    "HTML"
    CACHE STRING "The coverage report format (one of: `HTML`, `XML`)"
)
...
function(ENABLE_COVERAGE)
  ...
  if(NOT CMAKE_BUILD_TYPE STREQUAL "Coverage")
    message(
      WARNING "Code coverage requires \"Coverage\" build configuration. Disabling code coverage."
    )
    return()
  endif()
  ...
  if("${COVERAGE_REPORT_TYPE}" STREQUAL "XML")
    set(COVERAGE_REPORT_TYPE_FLAGS --xml-pretty --output ${CMAKE_PROJECT_NAME}.cov.xml)
  else()
    set(COVERAGE_REPORT_AUX_COMMANDS COMMAND ${CMAKE_COMMAND} -E remove_directory coverage COMMAND
                                     ${CMAKE_COMMAND} -E make_directory coverage
    )
    set(COVERAGE_REPORT_TYPE_FLAGS --html --html-details --output
                                   coverage/${CMAKE_PROJECT_NAME}.html
    )
  endif()
  ...
  add_custom_target(
    ...
    COMMAND ${GCOVR_EXECUTABLE} --gcov-executable ${GCOV_EXECUTABLE} --object-directory
            ${CMAKE_BINARY_DIR} --root ${CMAKE_SOURCE_DIR} --delete ${COVERAGE_REPORT_TYPE_FLAGS}
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
    COMMENT "Generate C++ code coverage report"
  )

  add_custom_target(coverage COMMENT "Create code coverage for ${CMAKE_PROJECT_NAME}")
