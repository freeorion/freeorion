...
ColorDlg::ColorDlg(X x, Y y, Clr original_color, const std::shared_ptr<Font>& font,
    ...
    m_hue_saturation_picker(nullptr),
    m_value_picker(nullptr),
    m_pickers_layout(nullptr),
    m_new_color_square(nullptr),
    m_old_color_square(nullptr),
    m_new_color_square_text(nullptr),
    m_old_color_square_text(nullptr),
    m_color_squares_layout(nullptr),
    m_color_buttons_layout(nullptr),
    m_current_color_button(INVALID_COLOR_BUTTON),
    m_ok(nullptr),
    m_cancel(nullptr),
    m_sliders_ok_cancel_layout(nullptr),
    ...
    m_text_color(text_color)
{
        ...
        })
    {
        ...
        m_slider_labels.push_back(
            style->NewTextControl(style->Translate(color_label), font, m_text_color, FORMAT_RIGHT));
        ...
        m_sliders.push_back(
            style->NewIntSlider(color_min, color_max, HORIZONTAL, m_color, 10));
