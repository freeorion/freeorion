    ...
    BlockControl(x, y, w, flags)
{
    ...
    m_text = new TextControl(GG::X0, GG::Y0, w, Y1, str, font, color, format | FORMAT_WORDBREAK | FORMAT_LINEWRAP | FORMAT_TOP , flags);
    AttachChild( m_text );
}
...
static int dummy = RichText::RegisterDefaultBlock(RichText::PLAINTEXT_TAG, new TextBlockFactory());
