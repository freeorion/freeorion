...
namespace {
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("ui.description.effects.shown")) {
            if (part->Location())
                detailed_description += "\n" + part->Location()->Dump();
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("ui.description.effects.shown") && !tech->Effects().empty()) {
            detailed_description += "\n" + Dump(tech->Effects());
        }
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("ui.description.effects.shown") && !species->Effects().empty()) {
