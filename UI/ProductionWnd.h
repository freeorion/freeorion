...
private:
    ...
    void    AddBuildToQueueSlot(BuildType build_type, const std::string& name, int number, int location, bool top);
    void    AddBuildToQueueSlot(BuildType build_type, int design_id, int number, int location, bool top);
