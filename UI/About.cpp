    ...
    m_end_with_done(false)
{
    ...
    m_info = new GG::MultiEdit(20, 20, 450, 400,"FreeOrion, an open-source game based o­n Master of Orion, is a turn-based game of epic space strategy that builds o­n the classic '4X' model by incorporating the nation-building elements of games such as Europa Universalis 2 and a versatile tactical combat engine. While its modular, open-source design allows for a significant degree of customization of the game engine and the story elements by the community, the FreeOrion team is dedicated to the construction of a living, breathing universe in a 'grand campaign' model.", ClientUI::FONT, ClientUI::PTS, GG::CLR_WHITE, GG::MultiEdit::READ_ONLY, ClientUI::TEXT_COLOR, GG::CLR_BLACK, GG::Wnd::CLICKABLE | GG::Wnd::DRAG_KEEPER);
