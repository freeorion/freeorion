...
namespace {
    ...
    void AddOptions(OptionsDB& db) {
        ...
        db.Add<std::string>("map.fleet.button.rollover.click.path", UserStringNop("OPTIONS_DB_UI_SOUND_FLEET_BUTTON_CLICK"),   (GetRootDataDir() / "default" / "data" / "sound" / "fleet_button_click.ogg").string());
