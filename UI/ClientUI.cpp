...
namespace {
    ...
    void AddOptions(OptionsDB& db) {
        ...
        db.Add("ui.window.design.pedia.title.dynamic.enabled", UserStringNop("OPTIONS_DB_DESIGN_PEDIA_DYNAMIC"), false);
        ...
        // Other
        db.Add("content.shipdesign.saved.enabled",     UserStringNop("OPTIONS_DB_AUTO_ADD_SAVED_DESIGNS"), true);
        db.Add("content.shipdesign.default.enabled",   UserStringNop("OPTIONS_DB_ADD_DEFAULT_DESIGNS"),    true);
