...
namespace {
    ...
    void AddOptions(OptionsDB& db) {
        db.Add("setup.starting.era",            UserStringNop("OPTIONS_DB_GAMESETUP_STARTING_ERA"),             STARTING_ERA_ADVANCED,      RangedValidator<StartingEra>(STARTING_ERA_ADVANCED, STARTING_ERA_PREWARP));
