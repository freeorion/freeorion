...
namespace {
    ...
    void Options(OptionsDB& db) {
        ...
        db.Add("gl_version.check.enabled",              UserStringNop("OPTIONS_DB_CHECKED_GL_VERSION"),        false);
    }
...
void IntroScreen::PreRender() {
    ...
    GG::Pt ul(Width()  * GetOptionsDB().Get<double>("ui.window.intro.menu.center.x") - mainmenu_width/2,
              Height() * GetOptionsDB().Get<double>("ui.window.intro.menu.center.y") - mainmenu_height/2);
    GG::Pt lr(Width()  * GetOptionsDB().Get<double>("ui.window.intro.menu.center.x") + mainmenu_width/2,
              Height() * GetOptionsDB().Get<double>("ui.window.intro.menu.center.y") + mainmenu_height/2);
