...
OptionsWnd::OptionsWnd():
    CUI_Wnd(UserString("ABOUT_WINDOW_TITLE"),100,100,300,205, GG::Wnd::CLICKABLE | GG::Wnd::DRAGABLE | GG::Wnd::MODAL),
    m_end_with_done(false)
{
    bool UI_sounds_enabled = GetOptionsDB().Get<bool>("UI.sound.enabled");
    TempUISoundDisabler sound_disabler;

	m_audio_str = new GG::TextControl(15,20,UserString("OPTIONS_AUDIO"),ClientUI::FONT,ClientUI::SIDE_PANEL_PLANET_NAME_PTS,ClientUI::TEXT_COLOR);

    m_music = new CUIStateButton(30,40,75,20,UserString("OPTIONS_MUSIC"),GG::TF_LEFT);
    m_ui_effects = new CUIStateButton(30,65,75,20,UserString("OPTIONS_UI_SOUNDS"),GG::TF_LEFT);
	
    m_music_volume = new CUISlider(30, 90, 150, 14, 0, 255, CUISlider::HORIZONTAL);
    m_music_volume_label = new GG::TextControl(30,105,UserString("OPTIONS_MUSIC_VOLUME"),ClientUI::FONT,ClientUI::SIDE_PANEL_PLANET_NAME_PTS,ClientUI::TEXT_COLOR);
    m_ui_sounds_volume = new CUISlider(30, 130, 150, 14, 0, 255, CUISlider::HORIZONTAL);
    m_ui_sounds_volume_label = new GG::TextControl(30,145,UserString("OPTIONS_UI_SOUNDS_VOLUME"),ClientUI::FONT,ClientUI::SIDE_PANEL_PLANET_NAME_PTS,ClientUI::TEXT_COLOR);

    m_done_btn = new CUIButton(20,170,75,UserString("DONE"));
