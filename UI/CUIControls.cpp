...
CUITabBar::CUITabBar(const boost::shared_ptr<GG::Font>& font, GG::Clr color, GG::Clr text_color,
    ...
    GG::TabBar(GG::X0, GG::Y0, GG::X1, font, color, text_color, style, flags)
{}
...
CUIListBox::CUIListBox(void):
    ListBox(ClientUI::CtrlBorderColor(), ClientUI::CtrlColor(), GG::INTERACTIVE)
{
    RecreateScrolls();
...
CUIEdit::CUIEdit(const std::string& str) :
    Edit(GG::X0, GG::Y0, GG::X1, str, ClientUI::GetFont(), ClientUI::CtrlBorderColor(), ClientUI::TextColor(), ClientUI::CtrlColor(), GG::INTERACTIVE | GG::REPEAT_KEY_PRESS)
{
