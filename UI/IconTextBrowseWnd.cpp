...
void IconTextBrowseWnd::PreRender() {
    ...
    m_title_text_label = new CUILabel(m_title_text, GG::FORMAT_LEFT);
    ...
    m_main_text_label = new CUILabel(m_main_text, GG::FORMAT_LEFT | GG::FORMAT_TOP | GG::FORMAT_WORDBREAK);
