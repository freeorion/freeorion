...
namespace {
    ...
    const std::string OPTIONS_ROOT = "ui.window.combat_report.summary.graph.";
    ...
    const std::string TOGGLE_BAR_HEALTH_SMOOTH = "bar.health_smooth.enabled";
    ...
    void AddOptions(OptionsDB& db) {
        ...
        db.Add<GG::Clr>("ui.window.combat_report.summary.dead.color",
                        UserStringNop("OPTIONS_DB_UI_COMBAT_SUMMARY_DEAD_COLOR"),
                        GG::Clr(128, 0, 0, 255));
        db.Add<GG::Clr>("ui.window.combat_report.summary.damaged.color",
                        UserStringNop("OPTIONS_DB_UI_COMBAT_SUMMARY_WOUND_COLOR"),
                        GG::CLR_RED);
        db.Add<GG::Clr>("ui.window.combat_report.summary.undamaged.color",
...
public:
        ...
        m_hovered(false)
    {
        ...
        m_dead_color = options.Get<GG::Clr>("ui.window.combat_report.summary.dead.color");
        m_wound_color = options.Get<GG::Clr>("ui.window.combat_report.summary.damaged.color");
        m_health_color = options.Get<GG::Clr>("ui.window.combat_report.summary.undamaged.color");
    }
