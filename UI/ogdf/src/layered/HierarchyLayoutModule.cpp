...
void HierarchyLayoutModule::addBends(ogdf::GraphCopyAttributes &AGC, ogdf::Hierarchy &H) {
...
void HierarchyLayoutModule::dynLayerDistance(ogdf::GraphCopyAttributes &AGC, ogdf::Hierarchy &H) {	
	if (H.high() < 1)
		return;
