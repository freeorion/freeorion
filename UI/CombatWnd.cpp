...
namespace
{
    GG::SubTexture GetSubTexture(const boost::filesystem::path& path, bool mipmap = false)
    {
        ...
        return GG::SubTexture(texture,GG::X0,GG::Y0,texture->DefaultWidth(),texture->DefaultHeight());
    }
}

class CombatInfoControl : public GG::Control {
public:
    CombatInfoControl(GG::X w, GG::Y h, const CombatUpdateMessage& combat_info) :
    ...
    virtual void Render()
    {
        ...
        const GG::Rect  item_txt[4] = {GG::Rect(GG::X(  7),GG::Y(27),GG::X(100),GG::Y(45)),
                                       GG::Rect(GG::X(  4),GG::Y(84),GG::X( 81),GG::Y(99)),
                                       GG::Rect(GG::X(124),GG::Y(49),GG::X(205),GG::Y(67)),
                                       GG::Rect(GG::X(124),GG::Y(78),GG::X(205),GG::Y(96))},
                         item_img_topic        (GG::X( 24),GG::Y(48),GG::X(24+40),GG::Y(48+40)),
                         item_img_arrow_split  (GG::X( 65),GG::Y(40),GG::X(65+64),GG::Y(40+64)),
                         rc_txt_empire         (GG::X( 25),GG::Y( 6),GG::X(500),GG::Y(19));
        ...
        GG::FlatRectangle(GG::Pt(ul.x+1, ul.y+1) ,lr, bg_color,border_color,2);
        ...
        rc = GG::Rect(ul+GG::Pt(GG::X(20),GG::Y(5)),ul+GG::Pt(GG::X(500),GG::Y(25)));
        ...
        rc = GG::Rect(ul+GG::Pt(GG::X(20+50),GG::Y(5)),ul+GG::Pt(GG::X(500),GG::Y(28)));
        ...
        for (unsigned int i = 0; i < m_combat_info.m_opponents.size(); i++, y += font->Height()+2) {
            ...
            GG::Rect area (ul.x+20,
                           ul.y+30+static_cast<int>(i)*110,
                           ul.x+20+ITEM_WIDTH*3,
                           ul.y+30+static_cast<int>(i+1)*110-5);
            struct {
                std::string txt;
            ...
            GG::FlatRectangle(GG::Pt(area.Left(), area.Top()), GG::Pt(area.Right()+2, area.Bottom()), bg_item_color,border_color, 2);
            ...
            for (unsigned int c = 0; c < 3; c++) {
                GG::Rect col (area.Left()+static_cast<int>(c)*ITEM_WIDTH,
                              area.Top(),
                              area.Left()+static_cast<int>(c+1)*ITEM_WIDTH,
                              area.Bottom());
                  
                GG::FlatRectangle(GG::Pt(col.Left(), col.Top()+38),
                                  GG::Pt(col.Right()+2, col.Bottom()),
                                  GG::CLR_ZERO, border_color, 2);
                glColor(ClientUI::TextColor());
                ...
                for (unsigned int j = 0; j < 4; j++) {
                    ...
                    GG::FlatRectangle(rc.ul, rc.lr, entries[c][j].bg_clr,entries[c][j].border_clr,entries[c][j].border_width);
                    glColor(ClientUI::TextColor());
...
{
    CombatInfoRow(GG::X w,const CombatUpdateMessage &combat_info) :
        GG::ListBox::Row(w, GG::Y(30+combat_info.m_opponents.size()*110), "CombatInfo")
    {
...
// CombatWnd
////////////////////////////////////////////////
const GG::X CombatWnd::WIDTH(800);
const GG::Y CombatWnd::HEIGHT(300);

CombatWnd::CombatWnd(GG::X x, GG::Y y)
: CUIWnd(UserString("COMBAT_WINDOW_TITLE"), x, y, WIDTH, HEIGHT,  GG::ONTOP | GG::CLICKABLE | GG::DRAGABLE | GG::RESIZABLE | MINIMIZABLE)
{
    m_combats_lb = new CUIListBox(GG::X0, GG::Y0, ClientWidth(), ClientHeight(), GG::CLR_ZERO, GG::CLR_ZERO);
