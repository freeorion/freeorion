...
void MapWnd::RefreshIndustryResourceIndicator() {
    ...
    double PP_to_stockpile_yield = empire->GetMeter("METER_IMPERIAL_PP_STORAGE_YIELD")->Current();
    double total_PP_to_stockpile = PP_to_stockpile_yield * (total_PP_output - total_PP_spent);
