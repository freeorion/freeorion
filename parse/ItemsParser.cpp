...
namespace parse {
    const lexer item_building_lexer;
    ...
    start_rule_payload items(const boost::filesystem::path& path) {
        ...
        detail::parse_file<grammar, start_rule_payload>(item_building_lexer, path, items_);
        return items_;
    }
    ...
    start_rule_payload starting_buildings(const boost::filesystem::path& path) {
        ...
        detail::parse_file<grammar, start_rule_payload>(item_building_lexer, path, starting_buildings_);
