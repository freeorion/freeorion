...
namespace {
    struct effect_parser_rules_4x {
        effect_parser_rules_4x(const parse::lexer& tok, const parse::effect_parser_rule& effect_parser) :
            int_rules(tok),
            double_rules(tok)
        {
            qi::_1_type _1;
...
namespace parse { namespace detail {
    const effect_parser_rule& effect_parser_4x(const effect_parser_rule& effect_parser) {
        static effect_parser_rules_4x retval(parse::lexer::instance(), effect_parser);
        return retval.start;
    }

    effect_parser_rules_4::effect_parser_rules_4(const parse::lexer& tok, const effect_parser_grammar& effect_parser) :
