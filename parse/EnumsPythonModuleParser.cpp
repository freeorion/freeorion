...
BOOST_PYTHON_MODULE(_enums) {
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<ResourceType>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<EmpireAffiliationType>(op.second);
    }
...
// TODO more meter types
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<MeterType>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper< ::PlanetEnvironment>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<ValueRef::StatisticType>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper< ::StarType>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<PlanetSize>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<PlanetType>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<ShipPartClass>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<UnlockableItemType>(op.second);
    }
    ...
    {
        py::scope().attr(op.first) = enum_wrapper<BuildType>(op.second);
    }
    ...
    {
        py::scope().attr(vis.first) = enum_wrapper<Visibility>(vis.second);
    }
