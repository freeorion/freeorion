...
<head>
 ...
 var codesite_token = "6_QL5lb-QrHLkv8jo58So05IQGU:1365060314476";
 
 
 var CS_env = {"assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","relativeBaseUrl":"","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"loggedInUserEmail":"GeoffTopping@gmail.com","projectName":"ogre-paged","profileUrl":"/u/107319084838887332900/","projectHomeUrl":"/p/ogre-paged","token":"6_QL5lb-QrHLkv8jo58So05IQGU:1365060314476"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fogre-paged%2Fsource%2Fbrowse%2Fsource%2FWindBatchedGeometry.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ogre-paged/source/browse/source/">source</a><span class="sp">/&nbsp;</span>WindBatchedGeometry.cpp</span>
 ...
 <a href="/p/ogre-paged/source/browse/source/WindBatchedGeometry.cpp?edit=1"
 ...
 <li><a href="/p/ogre-paged/source/browse/source/WindBatchedGeometry.cpp?r=8107d229606a79da64d487958ca2075678291418" title="Previous">&lsaquo;8107d229606a</a></li>
...
><td class="source">//WindBatchedGeometry.h<br></td></tr
><tr
...
><td class="source">#include &quot;WindBatchedGeometry.h&quot;<br></td></tr
><tr
...
><td class="source">WindBatchedGeometry::WindBatchedGeometry(SceneManager *mgr, SceneNode *rootSceneNode, const PagedGeometry *pagedGeom) : <br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_44

 onmouseover="gutterOver(44)"

><td class="source">BatchedGeometry(mgr, rootSceneNode),<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_45

 onmouseover="gutterOver(45)"

><td class="source">mGeom (pagedGeom)<br></td></tr
><tr
...
><td class="source">void WindBatchedGeometry::addEntity(Entity *ent, const Vector3 &amp;position, const Quaternion &amp;orientation, const Vector3 &amp;scale, const ColourValue &amp;color)<br></td></tr
><tr
...
><td class="source">	MeshPtr mesh = ent-&gt;getMesh();<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_56

 onmouseover="gutterOver(56)"

><td class="source">	if (mesh-&gt;sharedVertexData != NULL)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_57

 onmouseover="gutterOver(57)"

><td class="source">		OGRE_EXCEPT(Exception::ERR_INVALIDPARAMS, &quot;Shared vertex data not allowed&quot;, &quot;BatchedGeometry::addEntity()&quot;);<br></td></tr
><tr
...
><td class="source">	for (unsigned int i = 0, cntSubEnt = ent-&gt;getNumSubEntities(); i &lt; cntSubEnt; ++i)<br></td></tr
><tr
...
><td class="source">		WindSubBatch *batch;<br></td></tr
><tr
...
><td class="source">			batch = static_cast &lt; WindBatchedGeometry::WindSubBatch* &gt; (batchIter-&gt;second);  //Use the batch<br></td></tr
><tr
...
><td class="source">			batch = new WindSubBatch(this, subEntity);<br></td></tr
><tr
...
><td class="source">		batch-&gt;addSubEntity(subEntity, position, orientation, scale, color, ent);<br></td></tr
><tr
...
><td class="source">WindBatchedGeometry::WindSubBatch::WindSubBatch(WindBatchedGeometry *parent, SubEntity *ent) : <br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_115

 onmouseover="gutterOver(115)"

><td class="source">BatchedGeometry::SubBatch(parent, ent)<br></td></tr
><tr
...
><td class="source">void WindBatchedGeometry::WindSubBatch::build()<br></td></tr
><tr
...
><td class="source">	//Misc. setup<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_128

 onmouseover="gutterOver(128)"

><td class="source">	const Vector3 &amp;batchCenter = static_cast &lt; WindBatchedGeometry* &gt; (m_pParentGeom)-&gt;m_vecCenter;<br></td></tr
><tr
...
><td class="source">	HardwareIndexBuffer::IndexType destIndexType = <br></td></tr
><tr
...
><td class="source">	uint32 *indexBuffer32 = 0;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_141

 onmouseover="gutterOver(141)"

><td class="source">	uint16 *indexBuffer16 = 0;<br></td></tr
><tr
...
><td class="source">	unsigned short texCoordCount = 0;<br></td></tr
><tr
...
><td class="source">      const VertexDeclaration::VertexElementList &amp;vlist = vertDecl-&gt;getElements();<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_153

 onmouseover="gutterOver(153)"

><td class="source">      VertexDeclaration::VertexElementList::const_iterator it = vlist.begin(), iend = vlist.end();<br></td></tr
><tr
...
><td class="source">         if ((*it).getSemantic() == VES_TEXTURE_COORDINATES)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_157

 onmouseover="gutterOver(157)"

><td class="source">            ++texCoordCount;<br></td></tr
><tr
...
><td class="source">   Ogre::ushort numVertBuffs = (Ogre::ushort)vertBinding-&gt;getBufferCount();<br></td></tr
><tr
...
><td class="source">   vertDecl-&gt;addElement(numVertBuffs - 1, vertDecl-&gt;getVertexSize(0), VET_FLOAT4 , VES_TEXTURE_COORDINATES, texCoordCount);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_165

 onmouseover="gutterOver(165)"

><td class="source">   vertDecl-&gt;addElement(numVertBuffs - 1, vertDecl-&gt;getVertexSize(0), VET_FLOAT4 , VES_TEXTURE_COORDINATES, texCoordCount+1);<br></td></tr
><tr
...
><td class="source">   std::vector&lt;uchar*&gt; vertexBuffers(numVertBuffs);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_169

 onmouseover="gutterOver(169)"

><td class="source">   std::vector&lt;VertexDeclaration::VertexElementList&gt; vertexBufferElements(numVertBuffs);<br></td></tr
><tr
...
><td class="source">	for (Ogre::ushort i = 0; i &lt; numVertBuffs; ++i)<br></td></tr
><tr
...
><td class="source">		vertexBuffers[i] = static_cast&lt;uchar*&gt;(buffer-&gt;lock(HardwareBuffer::HBL_DISCARD));<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_179

 onmouseover="gutterOver(179)"

><td class="source">		vertexBufferElements[i] = vertDecl-&gt;findElementsBySource(i);<br></td></tr
><tr
...
><td class="source">   for (size_t iMesh = 0, meshCnt = m_queueMesh.size(); iMesh &lt; meshCnt; ++iMesh)<br></td></tr
><tr
...
><td class="source">		const QueuedMesh &amp;queuedMesh = m_queueMesh[iMesh];<br></td></tr
><tr
...
><td class="source">		const IndexData *sourceIndexData = queuedMesh.subMesh-&gt;indexData;<br></td></tr
><tr
...
><td class="source">		Entity * ent = static_cast&lt;Ogre::Entity*&gt;(queuedMesh.userData);<br></td></tr
><tr
...
><td class="source">      static const Ogre::String c_windFactorX = &quot;windFactorX&quot;, c_windFactorY = &quot;windFactorY&quot;;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_216

 onmouseover="gutterOver(216)"

><td class="source">		float factorX = static_cast&lt;WindBatchedGeometry*&gt;(m_pParentGeom)-&gt;mGeom-&gt;getCustomParam(ent-&gt;getName(), c_windFactorX, 0.f);	// amplitude in X<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_217

 onmouseover="gutterOver(217)"

><td class="source">		float factorY = static_cast&lt;WindBatchedGeometry*&gt;(m_pParentGeom)-&gt;mGeom-&gt;getCustomParam(ent-&gt;getName(), c_windFactorY, 0.f);	// amplitude in Y<br></td></tr
><tr
...
><td class="source">      Ogre::Real invMaxHeight = Ogre::Real(1.) / ent-&gt;getBoundingBox().getMaximum().y;<br></td></tr
><tr
...
><td class="source">		VertexBufferBinding *destBinds = m_pVertexData-&gt;vertexBufferBinding;<br></td></tr
><tr
...
><td class="source">      // SVA speed up. Rotate 3d vector by matrix 3x3 instead of quaternion<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_226

 onmouseover="gutterOver(226)"

><td class="source">      Ogre::Matrix3 m3MeshRotation;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_227

 onmouseover="gutterOver(227)"

><td class="source">      queuedMesh.orientation.ToRotationMatrix(m3MeshRotation);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_228

 onmouseover="gutterOver(228)"

><td class="source">      Ogre::Real *mat = m3MeshRotation[0]; // Ogre::Matrix is row major<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_229

 onmouseover="gutterOver(229)"

><td class="source">      Ogre::Vector3 v3AddBatchCenter = queuedMesh.position - batchCenter;<br></td></tr
><tr
...
><td class="source">		for (Ogre::ushort i = 0; i &lt; destBinds-&gt;getBufferCount(); ++i)<br></td></tr
><tr
...
><td class="source">			if (i &lt; sourceBinds-&gt;getBufferCount())<br></td></tr
><tr
...
><td class="source">				const HardwareVertexBufferSharedPtr &amp;sourceBuffer = sourceBinds-&gt;getBuffer(i);<br></td></tr
><tr
...
><td class="source">            size_t destVertexSize   = vertDecl-&gt;getVertexSize(i);<br></td></tr
><tr
...
><td class="source">				uchar *destBase = vertexBuffers[i];<br></td></tr
><tr
...
><td class="source">            const VertexDeclaration::VertexElementList &amp;elems = vertexBufferElements[i];<br></td></tr
><tr
...
><td class="source">            // vector to stock the original y value of every vertex because batchCenter doesn&#39;t take consider the height of the ground<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_248

 onmouseover="gutterOver(248)"

><td class="source">            Ogre::Vector3 vertexPos;<br></td></tr
><tr
...
><td class="source">				for (size_t v = 0, vertexCount = sourceVertexData-&gt;vertexCount; v &lt; vertexCount; ++v)<br></td></tr
><tr
...
><td class="source">               VertexDeclaration::VertexElementList::const_iterator itElement = iBegin;<br></td></tr
><tr
...
><td class="source">					for ( ; itElement != iEnd; ++itElement)<br></td></tr
><tr
...
><td class="source">						const VertexElement &amp;elem = *itElement;<br></td></tr
><tr
...
><td class="source">                        Ogre::Vector3 tmp(sourcePtr[0] * scale.x, sourcePtr[1] * scale.y, sourcePtr[2] * scale.z);<br></td></tr
><tr
...
><td class="source">                        vertexPos.x = mat[0] * tmp.x + mat[1] * tmp.y + mat[2] * tmp.z;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_269

 onmouseover="gutterOver(269)"

><td class="source">                        vertexPos.y = mat[3] * tmp.x + mat[4] * tmp.y + mat[5] * tmp.z;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_270

 onmouseover="gutterOver(270)"

><td class="source">                        vertexPos.z = mat[6] * tmp.x + mat[7] * tmp.y + mat[8] * tmp.z;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_271

 onmouseover="gutterOver(271)"

><td class="source">                        tmp = vertexPos + v3AddBatchCenter;<br></td></tr
><tr
...
><td class="source">                        Ogre::uint32 tmpColor = *(reinterpret_cast&lt;uint32*&gt;(sourcePtr));<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_292

 onmouseover="gutterOver(292)"

><td class="source">                        Ogre::uint8 tmpR = static_cast&lt;uint8&gt;((tmpColor &amp; 0xFF) * queuedMesh.color.r);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_293

 onmouseover="gutterOver(293)"

><td class="source">                        Ogre::uint8 tmpG = static_cast&lt;uint8&gt;(((tmpColor &gt;&gt; 8) &amp; 0xFF)  * queuedMesh.color.g);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_294

 onmouseover="gutterOver(294)"

><td class="source">                        Ogre::uint8 tmpB = static_cast&lt;uint8&gt;(((tmpColor &gt;&gt; 16) &amp; 0xFF) * queuedMesh.color.b);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_295

 onmouseover="gutterOver(295)"

><td class="source">                        Ogre::uint8 tmpA = static_cast&lt;uint8&gt;(((tmpColor &gt;&gt; 24) &amp; 0xFF) * queuedMesh.color.a);<br></td></tr
><tr
...
><td class="source">                        tmpColor = tmpR | (tmpG &lt;&lt; 8) | (tmpB &lt;&lt; 16) | (tmpA &lt;&lt; 24);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_298

 onmouseover="gutterOver(298)"

><td class="source">                        *(reinterpret_cast&lt;uint32*&gt;(destPtr)) = tmpColor;<br></td></tr
><tr
...
><td class="source">						case VES_TEXTURE_COORDINATES:<br></td></tr
><tr
...
><td class="source">                        if (elem.getIndex() == texCoordCount)<br></td></tr
><tr
...
><td class="source">                           // parameters to be passed to the shader<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_307

 onmouseover="gutterOver(307)"

><td class="source">                           destPtr[0] = float(vertexPos.x);                // radius coefficient<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_308

 onmouseover="gutterOver(308)"

><td class="source">                           destPtr[1] = float(vertexPos.y * invMaxHeight); // height coefficient<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_309

 onmouseover="gutterOver(309)"

><td class="source">                           destPtr[2] = factorX;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_310

 onmouseover="gutterOver(310)"

><td class="source">                           destPtr[3] = factorY;<br></td></tr
><tr
...
><td class="source">                        else if (elem.getIndex() == texCoordCount + 1)<br></td></tr
><tr
...
><td class="source">                           // original position for each vertex<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_315

 onmouseover="gutterOver(315)"

><td class="source">                           destPtr[0] = (float)queuedMesh.position.x;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_316

 onmouseover="gutterOver(316)"

><td class="source">                           destPtr[1] = (float)queuedMesh.position.y;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_317

 onmouseover="gutterOver(317)"

><td class="source">                           destPtr[2] = (float)queuedMesh.position.z;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_318

 onmouseover="gutterOver(318)"

><td class="source">                           destPtr[3] = 0.f;<br></td></tr
><tr
...
><td class="source">					destBase    += destVertexSize;<br></td></tr
><tr
...
><td class="source">				vertexBuffers[i] = destBase;<br></td></tr
><tr
...
><td class="source">				assert(m_RequireVertexColors);<br></td></tr
><tr
...
><td class="source">				uint32 *startPtr = (uint32*)vertexBuffers[vertBinding-&gt;getBufferCount()-1];<br></td></tr
><tr
...
><td class="source">				vertexBuffers[vertBinding-&gt;getBufferCount()-1] += (sizeof(uint32) * sourceVertexData-&gt;vertexCount);<br></td></tr
><tr
...
><td class="source">			sourceIndexData-&gt;indexBuffer-&gt;unlock();<br></td></tr
><tr
...
><td class="source">			//Increment the index offset<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_385

 onmouseover="gutterOver(385)"

><td class="source">			indexOffset += sourceVertexData-&gt;vertexCount;<br></td></tr
><tr
...
><td class="source">	m_queueMesh.clear();<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 by m2codeGEN (SVA)
 on May 25, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8bbc960029af74335b963770a933d78e564a859d&amp;format=side&amp;path=/source/WindBatchedGeometry.cpp&amp;old_path=/source/WindBatchedGeometry.cpp&amp;old=8107d229606a79da64d487958ca2075678291418">Diff</a>
 </div>
 ...
 var selected_path = '/source/WindBatchedGeometry.cpp';
 ...
 <a href="/p/ogre-paged/source/detail?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8107d229606a79da64d487958ca2075678291418">8107d229606a</a>
 by m2codeGEN (SVA)
 on May 18, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8107d229606a79da64d487958ca2075678291418&amp;format=side&amp;path=/source/WindBatchedGeometry.cpp&amp;old_path=/source/WindBatchedGeometry.cpp&amp;old=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2">Diff</a>
 <br>
 <pre class="ifOpened">WildBatchedGeometry::WildSubBatch::bui
ld matrix3 operator replaced</pre>
 </div>
 ...
 by m2codeGEN (SVA)
 on May 16, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2&amp;format=side&amp;path=/source/WindBatchedGeometry.cpp&amp;old_path=/source/WindBatchedGeometry.cpp&amp;old=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef">Diff</a>
 <br>
...
refactor</pre>
 ...
 by rortom
 on Apr 9, 2010
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef&amp;format=side&amp;path=/source/WindBatchedGeometry.cpp&amp;old_path=/source/WindBatchedGeometry.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">added svn files</pre>
 </div>
 
 
 <a href="/p/ogre-paged/source/list?path=/source/WindBatchedGeometry.cpp&r=8bbc960029af74335b963770a933d78e564a859d">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 18238 bytes,
 440 lines</div>
 
 <div><a href="//ogre-paged.googlecode.com/hg/source/WindBatchedGeometry.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn06de7ef9f7907b57123b0e03476e547a1db6ae08': '/source/WindBatchedGeometry.cpp'}
 codereviews = CR_controller.setup(
 {"assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","relativeBaseUrl":"","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"loggedInUserEmail":"GeoffTopping@gmail.com","projectName":"ogre-paged","profileUrl":"/u/107319084838887332900/","projectHomeUrl":"/p/ogre-paged","token":"6_QL5lb-QrHLkv8jo58So05IQGU:1365060314476"}, '', 'svn06de7ef9f7907b57123b0e03476e547a1db6ae08', paths,
