...
<head>
 ...
 var codesite_token = "hYB_h2IT9wCLtFsr05afYbFbLBc:1365060311045";
 
 
 var CS_env = {"projectHomeUrl":"/p/ogre-paged","assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","loggedInUserEmail":"GeoffTopping@gmail.com","relativeBaseUrl":"","token":"hYB_h2IT9wCLtFsr05afYbFbLBc:1365060311045","profileUrl":"/u/107319084838887332900/","domainName":null,"assetHostPath":"http://www.gstatic.com/codesite/ph","projectName":"ogre-paged"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fogre-paged%2Fsource%2Fbrowse%2Fsource%2FWindBatchPage.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ogre-paged/source/browse/source/">source</a><span class="sp">/&nbsp;</span>WindBatchPage.cpp</span>
 ...
 <a href="/p/ogre-paged/source/browse/source/WindBatchPage.cpp?edit=1"
 ...
 <li><a href="/p/ogre-paged/source/browse/source/WindBatchPage.cpp?r=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2" title="Previous">&lsaquo;4b9c9c16a1d3</a></li>
...
><td class="source">//WindBatchPage.cpp<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_12

 onmouseover="gutterOver(12)"

><td class="source">//WindBatchPage is an extension to PagedGeometry which displays entities as static geometry but that is affected by wind.<br></td></tr
><tr
...
><td class="source">#include &quot;WindBatchPage.h&quot;<br></td></tr
><tr
...
><td class="source">// to dump the shader source in a file<br></td></tr
><tr
...
><td class="source">void WindBatchPage::init(PagedGeometry *geom, const Any &amp;data)<br></td></tr
><tr
...
><td class="source">		OGRE_EXCEPT(Exception::ERR_INVALIDPARAMS,<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_45

 onmouseover="gutterOver(45)"

><td class="source">         &quot;Data of WindBatchPage must be a positive integer. It representing the LOD level this detail level stores.&quot;,<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_46

 onmouseover="gutterOver(46)"

><td class="source">         &quot;WindBatchPage::WindBatchPage&quot;);<br></td></tr
><tr
...
><td class="source">   m_pBatchGeom   = new WindBatchedGeometry(geom-&gt;getSceneManager(), geom-&gt;getSceneNode(), geom);<br></td></tr
><tr
...
><td class="source">   m_bShadersSupported = caps-&gt;hasCapability(RSC_VERTEX_PROGRAM) ? true : false;    // &lt;-- DELETE THIS<br></td></tr
><tr
...
><td class="source">void WindBatchPage::_updateShaders()<br></td></tr
><tr
...
><td class="source">		for (unsigned short t = 0, techCnt = ptrMat-&gt;getNumTechniques(); t &lt; techCnt; ++t)<br></td></tr
><tr
...
><td class="source">			for (unsigned short p = 0, passCnt = tech-&gt;getNumPasses(); p &lt; passCnt; ++p)<br></td></tr
><tr
...
><td class="source">		//Compile the shader script based on various material / fade options<br></td></tr
><tr
...
><td class="source">				int texNum = 0;<br></td></tr
><tr
...
><td class="source">				for (unsigned short j = 0; j &lt; subBatch-&gt;m_pVertexData-&gt;vertexDeclaration-&gt;getElementCount(); ++j) <br></td></tr
><tr
...
><td class="source">					const VertexElement *el = subBatch-&gt;m_pVertexData-&gt;vertexDeclaration-&gt;getElement(j);<br></td></tr
><tr
...
><td class="source">						if (el-&gt;getIndex() == texCoordCount - 2)<br></td></tr
><tr
...
><td class="source">								&quot;	float4 params 	: TEXCOORD&quot; + StringConverter::toString(texCoordCount-2) + &quot;, \n&quot;;<br></td></tr
><tr
...
><td class="source">							if (el-&gt;getIndex() == texCoordCount - 1)<br></td></tr
><tr
...
><td class="source">									&quot;	float4 originPos 	: TEXCOORD&quot; + StringConverter::toString(texCoordCount-1) + &quot;, \n&quot;;<br></td></tr
><tr
...
><td class="source">							&quot;	oColor = (lightAmbient + diffuseFactor * lightDiffuse); \n&quot;;<br></td></tr
><tr
...
><td class="source">							&quot;	oColor = float4(1, 1, 1, 1); \n&quot;;<br></td></tr
><tr
...
><td class="source">				for (unsigned short i = 0; i &lt; texCoordCount - 2; ++i)<br></td></tr
><tr
...
><td class="source">						&quot;	oUV&quot; + StringConverter::toString(i) + &quot; = iUV&quot; + StringConverter::toString(i) + &quot;; \n&quot;;<br></td></tr
><tr
...
><td class="source">					2 different methods are used to for the sin calculation :<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_283

 onmouseover="gutterOver(283)"

><td class="source">					- the first one gives a better effect but at the cost of a few fps because of the 2 sines<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_284

 onmouseover="gutterOver(284)"

><td class="source">					- the second one uses less ressources but is a bit less realistic<br></td></tr
><tr
...
><td class="source">						a sin approximation could be use to optimize performances<br></td></tr
><tr
...
><td class="source">					&quot;	tmpPos.y += sin(time + originPos.z + tmpPos.y + tmpPos.x) * radiusCoeff * radiusCoeff * factorY; \n&quot;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_290

 onmouseover="gutterOver(290)"

><td class="source">					&quot;	tmpPos.x += sin(time + originPos.z ) * heightCoeff * heightCoeff * factorX ; \n&quot;<br></td></tr
><tr
...
><td class="source">					&quot;	float sinval = sin(time + originPos.z ); \n&quot;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_293

 onmouseover="gutterOver(293)"

><td class="source">					&quot;	tmpPos.y += sinval * radiusCoeff * radiusCoeff * factorY; \n&quot;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_294

 onmouseover="gutterOver(294)"

><td class="source">					&quot;	tmpPos.x += sinval * heightCoeff * heightCoeff * factorX ; \n&quot;<br></td></tr
><tr
...
><td class="source">					&quot;	oPosition = mul(worldViewProj, tmpPos); \n&quot;<br></td></tr
><tr
...
><td class="source">								&quot;	vec4 params = gl_MultiTexCoord&quot; + StringConverter::toString(texCoordCount-2) + &quot;; \n&quot;;<br></td></tr
><tr
...
><td class="source">									&quot;	vec4 originPos = gl_MultiTexCoord&quot; + StringConverter::toString(texCoordCount-1) + &quot;; \n&quot;;<br></td></tr
><tr
...
><td class="source">						&quot;	float diffuseFactor = max(dot(gl_Normal.xyz, light), 0.0); \n&quot;;<br></td></tr
><tr
...
><td class="source">							&quot;	gl_FrontColor = (lightAmbient + diffuseFactor * lightDiffuse) * gl_Color; \n&quot;;<br></td></tr
><tr
...
><td class="source">							&quot;	gl_FrontColor = (lightAmbient + diffuseFactor * lightDiffuse); \n&quot;;<br></td></tr
><tr
...
><td class="source">					&quot;	vec4 tmpPos = gl_Vertex; \n&quot;<br></td></tr
><tr
...
><td class="source">					&quot;	gl_Position = gl_ModelViewProjectionMatrix * tmpPos; \n&quot;<br></td></tr
><tr
...
><td class="source">			// test for shader source<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_430

 onmouseover="gutterOver(430)"

><td class="source">			//std::ofstream shaderOutput;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_431

 onmouseover="gutterOver(431)"

><td class="source">			//shaderOutput.open((vertexProgName+std::string(&quot;.cg&quot;)).c_str());<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_432

 onmouseover="gutterOver(432)"

><td class="source">			//shaderOutput &lt;&lt; vertexProgSource;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_433

 onmouseover="gutterOver(433)"

><td class="source">			//shaderOutput.close();<br></td></tr
><tr
...
><td class="source">			// end test for shader source<br></td></tr
><tr
...
><td class="source">				vertexProgName,<br></td></tr
><tr
...
><td class="source">			for (unsigned short t = 0; t &lt; generatedMaterial-&gt;getNumTechniques(); ++t){<br></td></tr
><tr
...
><td class="source">						params-&gt;setNamedConstantFromTime(&quot;time&quot;, 1);<br></td></tr
><tr
...
><td class="source">					catch (const Ogre::Exception &amp;e)<br></td></tr
><tr
...
><td class="source">						shaderOutput.open(&quot;exception.log&quot;);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_524

 onmouseover="gutterOver(524)"

><td class="source">						shaderOutput &lt;&lt; e.getDescription();<br></td></tr
><tr
...
><td class="source">                     &quot;Error configuring batched geometry transitions. If you&#39;re using materials with custom\<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_531

 onmouseover="gutterOver(531)"

><td class="source">                     vertex shaders, they will need to implement fade transitions to be compatible with BatchPage.&quot;,<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_532

 onmouseover="gutterOver(532)"

><td class="source">                     &quot;BatchPage::_updateShaders()&quot;);<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 by m2codeGEN (SVA)
 on May 25, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8bbc960029af74335b963770a933d78e564a859d&amp;format=side&amp;path=/source/WindBatchPage.cpp&amp;old_path=/source/WindBatchPage.cpp&amp;old=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2">Diff</a>
 </div>
 ...
 var selected_path = '/source/WindBatchPage.cpp';
 ...
 by m2codeGEN (SVA)
 on May 16, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2&amp;format=side&amp;path=/source/WindBatchPage.cpp&amp;old_path=/source/WindBatchPage.cpp&amp;old=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef">Diff</a>
 <br>
...
refactor</pre>
 ...
 by rortom
 on Apr 9, 2010
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef&amp;format=side&amp;path=/source/WindBatchPage.cpp&amp;old_path=/source/WindBatchPage.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">added svn files</pre>
 </div>
 
 
 <a href="/p/ogre-paged/source/list?path=/source/WindBatchPage.cpp&r=8bbc960029af74335b963770a933d78e564a859d">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 18564 bytes,
 543 lines</div>
 
 <div><a href="//ogre-paged.googlecode.com/hg/source/WindBatchPage.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn06de7ef9f7907b57123b0e03476e547a1db6ae08': '/source/WindBatchPage.cpp'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl":"/p/ogre-paged","assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","loggedInUserEmail":"GeoffTopping@gmail.com","relativeBaseUrl":"","token":"hYB_h2IT9wCLtFsr05afYbFbLBc:1365060311045","profileUrl":"/u/107319084838887332900/","domainName":null,"assetHostPath":"http://www.gstatic.com/codesite/ph","projectName":"ogre-paged"}, '', 'svn06de7ef9f7907b57123b0e03476e547a1db6ae08', paths,
