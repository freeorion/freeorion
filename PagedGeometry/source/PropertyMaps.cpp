...
<head>
 ...
 var codesite_token = "2pLuSUB98rAK7V3zADsjShD8MW4:1365060293927";
 
 
 var CS_env = {"assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","projectName":"ogre-paged","assetHostPath":"http://www.gstatic.com/codesite/ph","relativeBaseUrl":"","loggedInUserEmail":"GeoffTopping@gmail.com","token":"2pLuSUB98rAK7V3zADsjShD8MW4:1365060293927","projectHomeUrl":"/p/ogre-paged","profileUrl":"/u/107319084838887332900/","domainName":null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fogre-paged%2Fsource%2Fbrowse%2Fsource%2FPropertyMaps.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ogre-paged/source/browse/source/">source</a><span class="sp">/&nbsp;</span>PropertyMaps.cpp</span>
 ...
 <a href="/p/ogre-paged/source/browse/source/PropertyMaps.cpp?edit=1"
 ...
 <li><a href="/p/ogre-paged/source/browse/source/PropertyMaps.cpp?r=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2" title="Previous">&lsaquo;4b9c9c16a1d3</a></li>
...
><td class="source">#include &lt;OgreTexture.h&gt;<br></td></tr
><tr
...
><td class="source">std::map&lt;String, DensityMap*&gt; DensityMap::selfList;<br></td></tr
><tr
...
><td class="source">DensityMap *DensityMap::load(const String &amp;fileName, MapChannel channel)<br></td></tr
><tr
...
><td class="source">	//Load image<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_33

 onmouseover="gutterOver(33)"

><td class="source">	TexturePtr map = TextureManager::getSingleton().load(fileName, ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME, TEX_TYPE_2D, 0);<br></td></tr
><tr
...
><td class="source">	//Copy image to pixelbox<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_36

 onmouseover="gutterOver(36)"

><td class="source">	return load(map, channel);<br></td></tr
><tr
...
><td class="source">DensityMap *DensityMap::load(TexturePtr texture, MapChannel channel)<br></td></tr
><tr
...
><td class="source">	const String key = texture-&gt;getName() + StringConverter::toString((int)channel);<br></td></tr
><tr
...
><td class="source">	std::map&lt;String, DensityMap*&gt;::iterator i;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_44

 onmouseover="gutterOver(44)"

><td class="source">	i = selfList.find(key);<br></td></tr
><tr
...
><td class="source">	DensityMap *m;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_47

 onmouseover="gutterOver(47)"

><td class="source">	if (i != selfList.end())<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_48

 onmouseover="gutterOver(48)"

><td class="source">		m = i-&gt;second;<br></td></tr
><tr
...
><td class="source">		m = new DensityMap(texture, channel);<br></td></tr
><tr
...
><td class="source">	++(m-&gt;refCount);<br></td></tr
><tr
...
><td class="source">void DensityMap::unload()<br></td></tr
><tr
...
><td class="source">	if (refCount == 0)<br></td></tr
><tr
...
><td class="source">	delete[] static_cast&lt;uint8*&gt;(pixels-&gt;data);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_67

 onmouseover="gutterOver(67)"

><td class="source">	delete pixels;<br></td></tr
><tr
...
><td class="source">	//Remove self from selfList<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_70

 onmouseover="gutterOver(70)"

><td class="source">	selfList.erase(selfKey);<br></td></tr
><tr
...
><td class="source">DensityMap::DensityMap(TexturePtr map, MapChannel channel)<br></td></tr
><tr
...
><td class="source">	assert(map.isNull() == false);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_76

 onmouseover="gutterOver(76)"

><td class="source">	filter = MAPFILTER_BILINEAR;<br></td></tr
><tr
...
><td class="source">	//Add self to selfList<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_79

 onmouseover="gutterOver(79)"

><td class="source">	selfKey = map-&gt;getName() + StringConverter::toString((int)channel);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_80

 onmouseover="gutterOver(80)"

><td class="source">	selfList.insert(std::pair&lt;String, DensityMap*&gt;(selfKey, this));<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_81

 onmouseover="gutterOver(81)"

><td class="source">	refCount = 0;<br></td></tr
><tr
...
><td class="source">	//Get the texture buffer<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_84

 onmouseover="gutterOver(84)"

><td class="source">	HardwarePixelBufferSharedPtr buff = map-&gt;getBuffer();<br></td></tr
><tr
...
><td class="source">	//Prepare a PixelBox (8-bit greyscale) to receive the density values<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_87

 onmouseover="gutterOver(87)"

><td class="source">	pixels = new PixelBox(Box(0, 0, buff-&gt;getWidth(), buff-&gt;getHeight()), PF_BYTE_L);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_88

 onmouseover="gutterOver(88)"

><td class="source">	pixels-&gt;data = new uint8[pixels-&gt;getConsecutiveSize()];<br></td></tr
><tr
...
><td class="source">	if (channel == CHANNEL_COLOR){<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_91

 onmouseover="gutterOver(91)"

><td class="source">		//Copy to the greyscale density map directly if no channel extraction is necessary<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_92

 onmouseover="gutterOver(92)"

><td class="source">		buff-&gt;blitToMemory(*pixels);<br></td></tr
><tr
...
><td class="source">		//If channel extraction is necessary, first convert to a PF_R8G8B8A8 format PixelBox<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_95

 onmouseover="gutterOver(95)"

><td class="source">		//This is necessary for the code below to properly extract the desired channel<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_96

 onmouseover="gutterOver(96)"

><td class="source">		PixelBox tmpPixels(Box(0, 0, buff-&gt;getWidth(), buff-&gt;getHeight()), PF_R8G8B8A8);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_97

 onmouseover="gutterOver(97)"

><td class="source">		tmpPixels.data = new uint8[tmpPixels.getConsecutiveSize()];<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_98

 onmouseover="gutterOver(98)"

><td class="source">		buff-&gt;blitToMemory(tmpPixels);<br></td></tr
><tr
...
><td class="source">		//Pick out a channel from the pixel buffer<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_101

 onmouseover="gutterOver(101)"

><td class="source">		size_t channelOffset;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_102

 onmouseover="gutterOver(102)"

><td class="source">		switch (channel){<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_103

 onmouseover="gutterOver(103)"

><td class="source">			case CHANNEL_RED: channelOffset = 3; break;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_104

 onmouseover="gutterOver(104)"

><td class="source">			case CHANNEL_GREEN: channelOffset = 2; break;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_105

 onmouseover="gutterOver(105)"

><td class="source">			case CHANNEL_BLUE: channelOffset = 1; break;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_106

 onmouseover="gutterOver(106)"

><td class="source">			case CHANNEL_ALPHA: channelOffset = 0; break;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_107

 onmouseover="gutterOver(107)"

><td class="source">			default: OGRE_EXCEPT(0, &quot;Invalid channel&quot;, &quot;GrassLayer::setDensityMap()&quot;); break;<br></td></tr
><tr
...
><td class="source">		//And copy that channel into the density map<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_111

 onmouseover="gutterOver(111)"

><td class="source">		uint8 *inputPtr = (uint8*)tmpPixels.data + channelOffset;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_112

 onmouseover="gutterOver(112)"

><td class="source">		uint8 *outputPtr = (uint8*)pixels-&gt;data;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_113

 onmouseover="gutterOver(113)"

><td class="source">		uint8 *outputEndPtr = outputPtr + pixels-&gt;getConsecutiveSize();<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_114

 onmouseover="gutterOver(114)"

><td class="source">		while (outputPtr != outputEndPtr){<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_115

 onmouseover="gutterOver(115)"

><td class="source">			*outputPtr++ = *inputPtr;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_116

 onmouseover="gutterOver(116)"

><td class="source">			inputPtr += 4;<br></td></tr
><tr
...
><td class="source">		//Finally, delete the temporary PF_R8G8B8A8 pixel buffer<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_120

 onmouseover="gutterOver(120)"

><td class="source">		delete[] static_cast&lt;uint8*&gt;(tmpPixels.data);<br></td></tr
><tr
...
><td class="source">//Returns the density map value at the given location<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_126

 onmouseover="gutterOver(126)"

><td class="source">//Make sure a density map exists before calling this.<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_127

 onmouseover="gutterOver(127)"

><td class="source">Ogre::Real DensityMap::_getDensityAt_Unfiltered(Ogre::Real x, Ogre::Real z, const TRect&lt;Real&gt; &amp;mapBounds)<br></td></tr
><tr
...
><td class="source">	// Early out if the coordinates are outside map bounds.<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_132

 onmouseover="gutterOver(132)"

><td class="source">	if(x &lt; mapBounds.left || x &gt;= mapBounds.right || z &lt; mapBounds.top || z &gt;= mapBounds.bottom)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_133

 onmouseover="gutterOver(133)"

><td class="source">      return 0.f;<br></td></tr
><tr
...
><td class="source">	size_t mapWidth = pixels-&gt;getWidth(), mapHeight = pixels-&gt;getHeight();<br></td></tr
><tr
...
><td class="source">#if OGRE_PLATFORM != OGRE_PLATFORM_APPLE<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_138

 onmouseover="gutterOver(138)"

><td class="source">	// Patch incorrect PixelBox::getWidth() in OpenGL mode<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_139

 onmouseover="gutterOver(139)"

><td class="source">	if (Root::getSingleton().getRenderSystem()-&gt;getName() == &quot;OpenGL Rendering Subsystem&quot;)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_140

 onmouseover="gutterOver(140)"

><td class="source">		--mapWidth;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_141

 onmouseover="gutterOver(141)"

><td class="source">#endif //OGRE_PLATFORM_APPLE<br></td></tr
><tr
...
><td class="source">	size_t xindex = size_t(mapWidth * (x - mapBounds.left) / mapBounds.width());<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_144

 onmouseover="gutterOver(144)"

><td class="source">	size_t zindex = size_t(mapHeight * (z - mapBounds.top) / mapBounds.height());<br></td></tr
><tr
...
><td class="source">	uint8 *data = reinterpret_cast&lt;uint8*&gt;(pixels-&gt;data);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_147

 onmouseover="gutterOver(147)"

><td class="source">	return data[mapWidth * zindex + xindex] * 0.00392157f; // 1/255.0f;<br></td></tr
><tr
...
><td class="source">//Returns the density map value at the given location with bilinear filtering<br></td></tr
><tr
...
><td class="source">Ogre::Real DensityMap::_getDensityAt_Bilinear(Ogre::Real x, Ogre::Real z, const TRect&lt;Ogre::Real&gt; &amp;mapBounds)<br></td></tr
><tr
...
><td class="source">	uint32 mapWidth = (uint32)pixels-&gt;getWidth();<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_161

 onmouseover="gutterOver(161)"

><td class="source">	uint32 mapHeight = (uint32)pixels-&gt;getHeight();<br></td></tr
><tr
...
><td class="source">	Ogre::Real xIndexFloat = (mapWidth * (x - mapBounds.left) / mapBounds.width()) - 0.5f;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_170

 onmouseover="gutterOver(170)"

><td class="source">	Ogre::Real zIndexFloat = (mapHeight * (z - mapBounds.top) / mapBounds.height()) - 0.5f;<br></td></tr
><tr
...
><td class="source">	uint32 xIndex = (uint32)xIndexFloat;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_173

 onmouseover="gutterOver(173)"

><td class="source">	uint32 zIndex = (uint32)zIndexFloat;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_174

 onmouseover="gutterOver(174)"

><td class="source">	if (xIndex &lt; 0 || zIndex &lt; 0 || xIndex &gt;= mapWidth-1 || zIndex &gt;= mapHeight-1)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_175

 onmouseover="gutterOver(175)"

><td class="source">		return 0.0f;<br></td></tr
><tr
...
><td class="source">	Ogre::Real xRatio = xIndexFloat - xIndex;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_178

 onmouseover="gutterOver(178)"

><td class="source">	Ogre::Real xRatioInv = 1.f - xRatio;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_179

 onmouseover="gutterOver(179)"

><td class="source">	Ogre::Real zRatio = zIndexFloat - zIndex;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_180

 onmouseover="gutterOver(180)"

><td class="source">	Ogre::Real zRatioInv = 1.f - zRatio;<br></td></tr
><tr
...
><td class="source">	uint8 *data = (uint8*)pixels-&gt;data;<br></td></tr
><tr
...
><td class="source">	Ogre::Real val11 = data[mapWidth * zIndex + xIndex]      * 0.0039215686274509803921568627451f;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_185

 onmouseover="gutterOver(185)"

><td class="source">	Ogre::Real val21 = data[mapWidth * zIndex + xIndex + 1]  * 0.0039215686274509803921568627451f;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_186

 onmouseover="gutterOver(186)"

><td class="source">	Ogre::Real val12 = data[mapWidth * ++zIndex + xIndex]    * 0.0039215686274509803921568627451f;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_187

 onmouseover="gutterOver(187)"

><td class="source">	Ogre::Real val22 = data[mapWidth * zIndex + xIndex + 1]  * 0.0039215686274509803921568627451f;<br></td></tr
><tr
...
><td class="source">	Ogre::Real val1 = xRatioInv * val11 + xRatio * val21;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_190

 onmouseover="gutterOver(190)"

><td class="source">	Ogre::Real val2 = xRatioInv * val12 + xRatio * val22;<br></td></tr
><tr
...
><td class="source">	return zRatioInv * val1 + zRatio * val2;<br></td></tr
><tr
...
><td class="source">std::map&lt;String, ColorMap*&gt; ColorMap::selfList;<br></td></tr
><tr
...
><td class="source">ColorMap *ColorMap::load(const String &amp;fileName, MapChannel channel)<br></td></tr
><tr
...
><td class="source">	TexturePtr map = TextureManager::getSingleton().load(fileName, ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME);<br></td></tr
><tr
...
><td class="source">ColorMap *ColorMap::load(TexturePtr texture, MapChannel channel)<br></td></tr
><tr
...
><td class="source">	std::map&lt;String, ColorMap*&gt;::iterator i;<br></td></tr
><tr
...
><td class="source">	ColorMap *m;<br></td></tr
><tr
...
><td class="source">		m = new ColorMap(texture, channel);<br></td></tr
><tr
...
><td class="source">void ColorMap::unload()<br></td></tr
><tr
...
><td class="source">ColorMap::ColorMap(TexturePtr map, MapChannel channel)<br></td></tr
><tr
...
><td class="source">	selfList.insert(std::pair&lt;String, ColorMap*&gt;(selfKey, this));<br></td></tr
><tr
...
><td class="source">	//Prepare a PixelBox (24-bit RGB) to receive the color values<br></td></tr
><tr
...
><td class="source">			//DirectX9<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_262

 onmouseover="gutterOver(262)"

><td class="source">			pixels = new PixelBox(Box(0, 0, buff-&gt;getWidth(), buff-&gt;getHeight()), PF_A8R8G8B8);<br></td></tr
><tr
...
><td class="source">			//OpenGL<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_266

 onmouseover="gutterOver(266)"

><td class="source">			pixels = new PixelBox(Box(0, 0, buff-&gt;getWidth(), buff-&gt;getHeight()), PF_A8B8G8R8);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_267

 onmouseover="gutterOver(267)"

><td class="source">			//Patch for Ogre&#39;s incorrect blitToMemory() when copying from PF_L8 in OpenGL<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_268

 onmouseover="gutterOver(268)"

><td class="source">			if (buff-&gt;getFormat() == PF_L8)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_269

 onmouseover="gutterOver(269)"

><td class="source">				channel = CHANNEL_RED;<br></td></tr
><tr
...
><td class="source">			OGRE_EXCEPT(0, &quot;Unknown RenderSystem color format&quot;, &quot;GrassLayer::setColorMap()&quot;);<br></td></tr
><tr
...
><td class="source">		//Copy to the color map directly if no channel extraction is necessary<br></td></tr
><tr
...
><td class="source">			default: OGRE_EXCEPT(0, &quot;Invalid channel&quot;, &quot;ColorMap::ColorMap()&quot;); break;<br></td></tr
><tr
...
><td class="source">			*outputPtr++ = 0xFF;	//Full alpha<br></td></tr
><tr
...
><td class="source">uint32 ColorMap::_getColorAt(Ogre::Real x, Ogre::Real z, const TRect&lt;Real&gt; &amp;mapBounds)<br></td></tr
><tr
...
><td class="source">	uint32 xindex = uint32(mapWidth * (x - mapBounds.left) / mapBounds.width());<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_330

 onmouseover="gutterOver(330)"

><td class="source">	uint32 zindex = uint32(mapHeight * (z - mapBounds.top) / mapBounds.height());<br></td></tr
><tr
...
><td class="source">	uint32 *data = (uint32*)pixels-&gt;data;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_333

 onmouseover="gutterOver(333)"

><td class="source">	return data[mapWidth * zindex + xindex];<br></td></tr
><tr
...
><td class="source">uint32 ColorMap::_interpolateColor(uint32 color1, uint32 color2, Ogre::Real ratio, Ogre::Real ratioInv)<br></td></tr
><tr
...
><td class="source">	uint8 a1 = (color1 &amp; 0xFF);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_339

 onmouseover="gutterOver(339)"

><td class="source">	uint8 b1 = (color1 &gt;&gt; 8 &amp; 0xFF);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_340

 onmouseover="gutterOver(340)"

><td class="source">	uint8 c1 = (color1 &gt;&gt; 16 &amp; 0xFF);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_341

 onmouseover="gutterOver(341)"

><td class="source">	uint8 d1 = (color1 &gt;&gt; 24 &amp; 0xFF);<br></td></tr
><tr
...
><td class="source">	uint8 a2 = (color2 &amp; 0xFF);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_344

 onmouseover="gutterOver(344)"

><td class="source">	uint8 b2 = (color2 &gt;&gt; 8 &amp; 0xFF);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_345

 onmouseover="gutterOver(345)"

><td class="source">	uint8 c2 = (color2 &gt;&gt; 16 &amp; 0xFF);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_346

 onmouseover="gutterOver(346)"

><td class="source">	uint8 d2 = (color2 &gt;&gt; 24 &amp; 0xFF);<br></td></tr
><tr
...
><td class="source">	uint8 a = uint8(ratioInv * a1 + ratio * a2);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_349

 onmouseover="gutterOver(349)"

><td class="source">	uint8 b = uint8(ratioInv * b1 + ratio * b2);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_350

 onmouseover="gutterOver(350)"

><td class="source">	uint8 c = uint8(ratioInv * c1 + ratio * c2);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_351

 onmouseover="gutterOver(351)"

><td class="source">	uint8 d = uint8(ratioInv * d1 + ratio * d2);<br></td></tr
><tr
...
><td class="source">	return a | (b &lt;&lt; 8) | (c &lt;&lt; 16) | (d &lt;&lt; 24);<br></td></tr
><tr
...
><td class="source">uint32 ColorMap::_getColorAt_Bilinear(Ogre::Real x, Ogre::Real z, const TRect&lt;Real&gt; &amp;mapBounds)<br></td></tr
><tr
...
><td class="source">	uint32 val11 = data[mapWidth * zIndex + xIndex];<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_384

 onmouseover="gutterOver(384)"

><td class="source">	uint32 val21 = data[mapWidth * zIndex + xIndex + 1];<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_385

 onmouseover="gutterOver(385)"

><td class="source">	uint32 val12 = data[mapWidth * ++zIndex + xIndex];<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_386

 onmouseover="gutterOver(386)"

><td class="source">	uint32 val22 = data[mapWidth * zIndex + xIndex + 1];<br></td></tr
><tr
...
><td class="source">	uint32 val1 = _interpolateColor(val11, val21, xRatio, xRatioInv);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_389

 onmouseover="gutterOver(389)"

><td class="source">	uint32 val2 = _interpolateColor(val12, val22, xRatio, xRatioInv);<br></td></tr
><tr
...
><td class="source">	uint32 val = _interpolateColor(val1, val2, zRatio, zRatioInv);<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 by m2codeGEN (SVA)
 on May 25, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8bbc960029af74335b963770a933d78e564a859d&amp;format=side&amp;path=/source/PropertyMaps.cpp&amp;old_path=/source/PropertyMaps.cpp&amp;old=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2">Diff</a>
 </div>
 ...
 var selected_path = '/source/PropertyMaps.cpp';
 ...
 by m2codeGEN (SVA)
 on May 16, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2&amp;format=side&amp;path=/source/PropertyMaps.cpp&amp;old_path=/source/PropertyMaps.cpp&amp;old=64c24a899c446c83e20a6044f76b12e5965b860c">Diff</a>
 <br>
...
refactor</pre>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="http://www.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="http://www.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/ogre-paged/source/detail?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=64c24a899c446c83e20a6044f76b12e5965b860c">64c24a899c44</a>
 by Thomas Fischer &lt;tho...@rigsofrods.com&gt;
 on Feb 22, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=64c24a899c446c83e20a6044f76b12e5965b860c&amp;format=side&amp;path=/source/PropertyMaps.cpp&amp;old_path=/source/PropertyMaps.cpp&amp;old=4dbe8c6794456b45ab423e15ed2ba1fa53450c0c">Diff</a>
 <br>
 <pre class="ifOpened">improved loading time of density maps:
<a href="http://redmine.rigsofrods.com/issues/4" rel="nofollow">http://redmine.rigsofrods.com/issues/4</a>
32</pre>
 </div>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="http://www.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="http://www.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/ogre-paged/source/detail?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=4dbe8c6794456b45ab423e15ed2ba1fa53450c0c">4dbe8c679445</a>
 by rortom
 on Jun 28, 2010
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=4dbe8c6794456b45ab423e15ed2ba1fa53450c0c&amp;format=side&amp;path=/source/PropertyMaps.cpp&amp;old_path=/source/PropertyMaps.cpp&amp;old=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef">Diff</a>
 <br>
 <pre class="ifOpened">closes Code Review #326</pre>
 </div>
 
 
 <a href="/p/ogre-paged/source/list?path=/source/PropertyMaps.cpp&r=8bbc960029af74335b963770a933d78e564a859d">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 13594 bytes,
 395 lines</div>
 
 <div><a href="//ogre-paged.googlecode.com/hg/source/PropertyMaps.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn06de7ef9f7907b57123b0e03476e547a1db6ae08': '/source/PropertyMaps.cpp'}
 codereviews = CR_controller.setup(
 {"assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","projectName":"ogre-paged","assetHostPath":"http://www.gstatic.com/codesite/ph","relativeBaseUrl":"","loggedInUserEmail":"GeoffTopping@gmail.com","token":"2pLuSUB98rAK7V3zADsjShD8MW4:1365060293927","projectHomeUrl":"/p/ogre-paged","profileUrl":"/u/107319084838887332900/","domainName":null}, '', 'svn06de7ef9f7907b57123b0e03476e547a1db6ae08', paths,
