...
<head>
 ...
 var codesite_token = "Xy-tVSlX8JLDF4xhDnFFvHMYvg4:1365060303835";
 
 
 var CS_env = {"assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","profileUrl":"/u/107319084838887332900/","loggedInUserEmail":"GeoffTopping@gmail.com","assetHostPath":"http://www.gstatic.com/codesite/ph","relativeBaseUrl":"","projectHomeUrl":"/p/ogre-paged","token":"Xy-tVSlX8JLDF4xhDnFFvHMYvg4:1365060303835","projectName":"ogre-paged","domainName":null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fogre-paged%2Fsource%2Fbrowse%2Fsource%2FTreeLoader2D.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ogre-paged/source/browse/source/">source</a><span class="sp">/&nbsp;</span>TreeLoader2D.cpp</span>
 ...
 <a href="/p/ogre-paged/source/browse/source/TreeLoader2D.cpp?edit=1"
 ...
 <li><a href="/p/ogre-paged/source/browse/source/TreeLoader2D.cpp?r=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2" title="Previous">&lsaquo;4b9c9c16a1d3</a></li>
...
><td class="source">#include &quot;TreeLoader2D.h&quot;<br></td></tr
><tr
...
><td class="source">TreeLoader2D::TreeLoader2D(PagedGeometry *geom, const TBounds &amp;bounds)<br></td></tr
><tr
...
><td class="source">	TreeLoader2D::geom = geom;<br></td></tr
><tr
...
><td class="source">	//Reset height function<br></td></tr
><tr
...
><td class="source">TreeLoader2D::~TreeLoader2D()<br></td></tr
><tr
...
><td class="source">void TreeLoader2D::addTree(Entity *entity, const Vector3 &amp;position, Degree yaw, Real scale, void* userData)<br></td></tr
><tr
...
><td class="source">	//Real x = pos.x;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_97

 onmouseover="gutterOver(97)"

><td class="source">	//Real z = pos.z;<br></td></tr
><tr
...
><td class="source">   std::vector&lt;TreeDef&gt; *pageGrid = 0;<br></td></tr
><tr
...
><td class="source">	PageGridListIterator i = pageGridList.find(entity);<br></td></tr
><tr
...
><td class="source">		pageGrid = i-&gt;second;   // If it exists, get the page grid<br></td></tr
><tr
...
><td class="source">	int pageX = (int)Math::Floor(xrel / pageSize); // bad perfomance float --&gt; int<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_118

 onmouseover="gutterOver(118)"

><td class="source">	int pageZ = (int)Math::Floor(zrel / pageSize); // bad perfomance float --&gt; int<br></td></tr
><tr
...
><td class="source">	tree.xPos      = static_cast&lt;uint16&gt;(0xFFFF * (xrel - (pageX * pageSize)) / pageSize);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_124

 onmouseover="gutterOver(124)"

><td class="source">	tree.zPos      = static_cast&lt;uint16&gt;(0xFFFF * (zrel - (pageZ * pageSize)) / pageSize);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_125

 onmouseover="gutterOver(125)"

><td class="source">   tree.rotation  = static_cast&lt;uint8&gt;(Ogre::Real(0.708) * yaw.valueDegrees());                       // 0.708 ~= 255 / 360<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_126

 onmouseover="gutterOver(126)"

><td class="source">   tree.scale     = static_cast&lt;uint8&gt;(Ogre::Real(255.) * ((scale - minimumScale) / maximumScale));<br></td></tr
><tr
...
><td class="source">	geom-&gt;reloadGeometryPage(Vector3(pos.x, 0, pos.z));<br></td></tr
><tr
...
><td class="source">TreeLoader2D::deleteTrees(const Ogre::Vector3 &amp;position, Ogre::Real radius, Entity *type)<br></td></tr
><tr
...
><td class="source">	int minPageX = (int)Math::Floor(((x-radius) - gridBounds.left) / pageSize);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_174

 onmouseover="gutterOver(174)"

><td class="source">	int minPageZ = (int)Math::Floor(((z-radius) - gridBounds.top) / pageSize);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_175

 onmouseover="gutterOver(175)"

><td class="source">	int maxPageX = (int)Math::Floor(((x+radius) - gridBounds.left) / pageSize);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_176

 onmouseover="gutterOver(176)"

><td class="source">	int maxPageZ = (int)Math::Floor(((z+radius) - gridBounds.top) / pageSize);<br></td></tr
><tr
...
><td class="source">TreeLoader2D::deleteTrees(TBounds area, Ogre::Entity *type)<br></td></tr
><tr
...
><td class="source">std::vector&lt;void*&gt; TreeLoader2D::findTrees(const Ogre::Vector3 &amp;position, Real radius, Entity *type)<br></td></tr
><tr
...
><td class="source">void TreeLoader2D::setColorMap(const Ogre::String &amp;mapFile, MapChannel channel)<br></td></tr
><tr
...
><td class="source">void TreeLoader2D::setColorMap(Ogre::TexturePtr map, MapChannel channel)<br></td></tr
><tr
...
><td class="source">void TreeLoader2D::loadPage(PageInfo &amp;page)<br></td></tr
><tr
...
><td class="source">			//Calculate terrain height at pos.x / pos.z to get pos.y<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_468

 onmouseover="gutterOver(468)"

><td class="source">			if (heightFunction != NULL)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_469

 onmouseover="gutterOver(469)"

><td class="source">				pos.y = heightFunction(pos.x, pos.z, heightFunctionUserData);<br></td></tr
><tr
...
><td class="source">				pos.y = 0.0f;<br></td></tr
><tr
...
><td class="source">TreeIterator2D TreeLoader2D::getTrees()<br></td></tr
><tr
...
><td class="source">	return TreeIterator2D(this);<br></td></tr
><tr
...
><td class="source">TreeIterator2D::TreeIterator2D(TreeLoader2D *trees)<br></td></tr
><tr
...
><td class="source">	TreeIterator2D::trees = trees;<br></td></tr
><tr
...
><td class="source">TreeRef TreeIterator2D::getNext()<br></td></tr
><tr
...
><td class="source">void TreeIterator2D::moveNext()<br></td></tr
><tr
...
><td class="source">void TreeIterator2D::_readTree()<br></td></tr
><tr
...
><td class="source">	TreeLoader2D::TreeDef treeDef = *currentTree;<br></td></tr
><tr
...
><td class="source">	//Calculate terrain height at x / z to get y<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_586

 onmouseover="gutterOver(586)"

><td class="source">	if (trees-&gt;heightFunction != NULL)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_587

 onmouseover="gutterOver(587)"

><td class="source">		currentTreeDat.position.y = trees-&gt;heightFunction(currentTreeDat.position.x, currentTreeDat.position.z, trees-&gt;heightFunctionUserData);<br></td></tr
><tr
...
><td class="source">		currentTreeDat.position.y = 0.0f;<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 by m2codeGEN (SVA)
 on May 25, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8bbc960029af74335b963770a933d78e564a859d&amp;format=side&amp;path=/source/TreeLoader2D.cpp&amp;old_path=/source/TreeLoader2D.cpp&amp;old=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2">Diff</a>
 </div>
 ...
 var selected_path = '/source/TreeLoader2D.cpp';
 ...
 by m2codeGEN (SVA)
 on May 16, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=4b9c9c16a1d37aebb2a47614615e6809d17b5ae2&amp;format=side&amp;path=/source/TreeLoader2D.cpp&amp;old_path=/source/TreeLoader2D.cpp&amp;old=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef">Diff</a>
 <br>
...
refactor</pre>
 ...
 by rortom
 on Apr 9, 2010
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef&amp;format=side&amp;path=/source/TreeLoader2D.cpp&amp;old_path=/source/TreeLoader2D.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">added svn files</pre>
 </div>
 
 
 <a href="/p/ogre-paged/source/list?path=/source/TreeLoader2D.cpp&r=8bbc960029af74335b963770a933d78e564a859d">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 20190 bytes,
 602 lines</div>
 
 <div><a href="//ogre-paged.googlecode.com/hg/source/TreeLoader2D.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn06de7ef9f7907b57123b0e03476e547a1db6ae08': '/source/TreeLoader2D.cpp'}
 codereviews = CR_controller.setup(
 {"assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","profileUrl":"/u/107319084838887332900/","loggedInUserEmail":"GeoffTopping@gmail.com","assetHostPath":"http://www.gstatic.com/codesite/ph","relativeBaseUrl":"","projectHomeUrl":"/p/ogre-paged","token":"Xy-tVSlX8JLDF4xhDnFFvHMYvg4:1365060303835","projectName":"ogre-paged","domainName":null}, '', 'svn06de7ef9f7907b57123b0e03476e547a1db6ae08', paths,
