...
<head>
 ...
 var codesite_token = "Rmk-M35DuraAtOFkuFZdmCggctQ:1365060177711";
 
 
 var CS_env = {"loggedInUserEmail":"GeoffTopping@gmail.com","relativeBaseUrl":"","projectHomeUrl":"/p/ogre-paged","assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"projectName":"ogre-paged","token":"Rmk-M35DuraAtOFkuFZdmCggctQ:1365060177711","profileUrl":"/u/107319084838887332900/"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fogre-paged%2Fsource%2Fbrowse%2Finclude%2FRandomTable.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ogre-paged/source/browse/include/">include</a><span class="sp">/&nbsp;</span>RandomTable.h</span>
 ...
 <a href="/p/ogre-paged/source/browse/include/RandomTable.h?edit=1"
 ...
 <li><a href="/p/ogre-paged/source/browse/include/RandomTable.h?r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef" title="Previous">&lsaquo;39f8aaf4be3c</a></li>
...
><td class="source">#ifndef __RandomTable_H__<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_12

 onmouseover="gutterOver(12)"

><td class="source">#define __RandomTable_H__<br></td></tr
><tr
...
><td class="source">#include &lt;OgreMath.h&gt;<br></td></tr
><tr
...
><td class="source">#include &lt;time.h&gt; // for time<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_18

 onmouseover="gutterOver(18)"

><td class="source">#include &quot;MersenneTwister.h&quot;<br></td></tr
><tr
...
><td class="source">// random table class that speeds up PG a bit<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_21

 onmouseover="gutterOver(21)"

><td class="source">class RandomTable<br></td></tr
><tr
...
><td class="source">	RandomTable(unsigned long size=0x8000);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_25

 onmouseover="gutterOver(25)"

><td class="source">	~RandomTable();<br></td></tr
><tr
...
><td class="source">	void resetRandomIndex();<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_28

 onmouseover="gutterOver(28)"

><td class="source">	float getUnitRandom();<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_29

 onmouseover="gutterOver(29)"

><td class="source">	float getRangeRandom(float start, float end);<br></td></tr
><tr
...
><td class="source">	unsigned long tableSize;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_33

 onmouseover="gutterOver(33)"

><td class="source">	float *table;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_34

 onmouseover="gutterOver(34)"

><td class="source">	unsigned long customRandomIndex;<br></td></tr
><tr
...
><td class="source">	void generateRandomNumbers();	<br></td></tr
><tr
...
><td class="source">// implementation below<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_41

 onmouseover="gutterOver(41)"

><td class="source">inline RandomTable::RandomTable(unsigned long size) : tableSize(size), table(0), customRandomIndex(0)<br></td></tr
><tr
...
><td class="source">	table = (float *)malloc(sizeof(float) * tableSize);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_44

 onmouseover="gutterOver(44)"

><td class="source">	generateRandomNumbers();<br></td></tr
><tr
...
><td class="source">inline RandomTable::~RandomTable()<br></td></tr
><tr
...
><td class="source">	if(table)<br></td></tr
><tr
...
><td class="source">		free(table);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_52

 onmouseover="gutterOver(52)"

><td class="source">		table=0;<br></td></tr
><tr
...
><td class="source">inline void RandomTable::resetRandomIndex()<br></td></tr
><tr
...
><td class="source">	customRandomIndex = 0;<br></td></tr
><tr
...
><td class="source">inline float RandomTable::getUnitRandom()<br></td></tr
><tr
...
><td class="source">	// prevent against overflow<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_64

 onmouseover="gutterOver(64)"

><td class="source">	if(customRandomIndex &gt; tableSize - 1)<br></td></tr
><tr
...
><td class="source">	return table[customRandomIndex++];<br></td></tr
><tr
...
><td class="source">inline float RandomTable::getRangeRandom(float start, float end)<br></td></tr
><tr
...
><td class="source">	return (start + ((end - start) * getUnitRandom()));<br></td></tr
><tr
...
><td class="source">inline void RandomTable::generateRandomNumbers()<br></td></tr
><tr
...
><td class="source">	srand(time(NULL));<br></td></tr
><tr
...
><td class="source">	for(unsigned long i = 0; i &lt; tableSize; i++)<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_85

 onmouseover="gutterOver(85)"

><td class="source">		table[i] = Ogre::Math::UnitRandom();<br></td></tr
><tr
...
><td class="source">	// using our Mersenne Twister (preferred way)<br></td></tr
><tr
...
><td class="source">	MTRand mtrand(GetTickCount());<br></td></tr
><tr
...
><td class="source">	MTRand mtrand(time(NULL));<br></td></tr
><tr
...
><td class="source">		table[i] = (float)mtrand.rand();<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_95

 onmouseover="gutterOver(95)"

><td class="source">#endif //USE_OGRE_RANDOM<br></td></tr
><tr
...
><td class="source">#endif // __RandomTable_H__<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 by m2codeGEN (SVA)
 on May 25, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8bbc960029af74335b963770a933d78e564a859d&amp;format=side&amp;path=/include/RandomTable.h&amp;old_path=/include/RandomTable.h&amp;old=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef">Diff</a>
 </div>
 ...
 var selected_path = '/include/RandomTable.h';
 ...
 by rortom
 on Apr 9, 2010
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef&amp;format=side&amp;path=/include/RandomTable.h&amp;old_path=/include/RandomTable.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">added svn files</pre>
 </div>
 
 
 <a href="/p/ogre-paged/source/list?path=/include/RandomTable.h&r=8bbc960029af74335b963770a933d78e564a859d">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//ogre-paged.googlecode.com/hg/include/RandomTable.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn06de7ef9f7907b57123b0e03476e547a1db6ae08': '/include/RandomTable.h'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail":"GeoffTopping@gmail.com","relativeBaseUrl":"","projectHomeUrl":"/p/ogre-paged","assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"projectName":"ogre-paged","token":"Rmk-M35DuraAtOFkuFZdmCggctQ:1365060177711","profileUrl":"/u/107319084838887332900/"}, '', 'svn06de7ef9f7907b57123b0e03476e547a1db6ae08', paths,
