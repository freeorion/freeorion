...
<head>
 ...
 var codesite_token = "wwkrzCnRPlNs_x1f4wYdvNhhAVE:1365060191060";
 
 
 var CS_env = {"token":"wwkrzCnRPlNs_x1f4wYdvNhhAVE:1365060191060","profileUrl":"/u/107319084838887332900/","projectName":"ogre-paged","projectHomeUrl":"/p/ogre-paged","assetHostPath":"http://www.gstatic.com/codesite/ph","loggedInUserEmail":"GeoffTopping@gmail.com","assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","domainName":null,"relativeBaseUrl":""};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fogre-paged%2Fsource%2Fbrowse%2Finclude%2FWindBatchPage.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ogre-paged/source/browse/include/">include</a><span class="sp">/&nbsp;</span>WindBatchPage.h</span>
 ...
 <a href="/p/ogre-paged/source/browse/include/WindBatchPage.h?edit=1"
 ...
 <li><a href="/p/ogre-paged/source/browse/include/WindBatchPage.h?r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef" title="Previous">&lsaquo;39f8aaf4be3c</a></li>
...
><td class="source">/// \file WindBatchPage.h<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_12

 onmouseover="gutterOver(12)"

><td class="source">/// \brief WindBatchPage is child of BatchPage to include a wind effect.<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_13

 onmouseover="gutterOver(13)"

><td class="source">#ifndef __WindBatchPage_H__<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_14

 onmouseover="gutterOver(14)"

><td class="source">#define __WindBatchPage_H__<br></td></tr
><tr
...
><td class="source">   \brief The WindBatchPage class renders entities as StaticGeometry with hardware accelerated wind animation capability.<br></td></tr
><tr
...
><td class="source">   PagedGeometry::addDetailLevel&lt;WindBatchPage&gt;(farRange, transitionLength, Ogre::Any(LODLevel));<br></td></tr
><tr
...
><td class="source">   This page type (WindBatchPage) is almost identical to BatchPage, except it includes additional<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_40

 onmouseover="gutterOver(40)"

><td class="source">   code to support a hardware accelerated wind animation technique (through a vertex shader). To<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_41

 onmouseover="gutterOver(41)"

><td class="source">   enable animation on your tree(s), use PagedGeometry::setCustomParam() to set the following<br></td></tr
><tr
...
><td class="source">   windFactorX - Horizontal tree sway magnitude<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_45

 onmouseover="gutterOver(45)"

><td class="source">   windFactorY - Vertical tree sway magnitude<br></td></tr
><tr
...
><td class="source">   See Example 8 for a practical example of using WindBatchPage.<br></td></tr
><tr
...
><td class="source">   Special thanks to Wendigo Studios (www.wendigostudios.com) for donating this extension of<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_50

 onmouseover="gutterOver(50)"

><td class="source">   BatchPage to the PagedGeometry project.<br></td></tr
><tr
...
><td class="source">   class WindBatchPage: public BatchPage<br></td></tr
><tr
...
><td class="source">      WindBatchPage() : m_pPagedGeom(NULL) { /* empty */ }<br></td></tr
><tr
...
><td class="source">      Ogre::String            m_strEntityName;     ///&lt;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_65

 onmouseover="gutterOver(65)"

><td class="source">      const PagedGeometry*    m_pPagedGeom;        ///&lt;<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 by m2codeGEN (SVA)
 on May 25, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8bbc960029af74335b963770a933d78e564a859d&amp;format=side&amp;path=/include/WindBatchPage.h&amp;old_path=/include/WindBatchPage.h&amp;old=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef">Diff</a>
 </div>
 ...
 var selected_path = '/include/WindBatchPage.h';
 ...
 by rortom
 on Apr 9, 2010
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef&amp;format=side&amp;path=/include/WindBatchPage.h&amp;old_path=/include/WindBatchPage.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">added svn files</pre>
 </div>
 
 
 <a href="/p/ogre-paged/source/list?path=/include/WindBatchPage.h&r=8bbc960029af74335b963770a933d78e564a859d">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//ogre-paged.googlecode.com/hg/include/WindBatchPage.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn06de7ef9f7907b57123b0e03476e547a1db6ae08': '/include/WindBatchPage.h'}
 codereviews = CR_controller.setup(
 {"token":"wwkrzCnRPlNs_x1f4wYdvNhhAVE:1365060191060","profileUrl":"/u/107319084838887332900/","projectName":"ogre-paged","projectHomeUrl":"/p/ogre-paged","assetHostPath":"http://www.gstatic.com/codesite/ph","loggedInUserEmail":"GeoffTopping@gmail.com","assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","domainName":null,"relativeBaseUrl":""}, '', 'svn06de7ef9f7907b57123b0e03476e547a1db6ae08', paths,
