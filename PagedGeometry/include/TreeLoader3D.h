...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fogre-paged%2Fsource%2Fbrowse%2Finclude%2FTreeLoader3D.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ogre-paged/source/browse/include/">include</a><span class="sp">/&nbsp;</span>TreeLoader3D.h</span>
 ...
 <a href="/p/ogre-paged/source/browse/include/TreeLoader3D.h?edit=1"
 ...
 <li><a href="/p/ogre-paged/source/browse/include/TreeLoader3D.h?r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef" title="Previous">&lsaquo;39f8aaf4be3c</a></li>
...
><td class="source">#ifndef __TreeLoader3D_H__<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_12

 onmouseover="gutterOver(12)"

><td class="source">#define __TreeLoader3D_H__<br></td></tr
><tr
...
><td class="source">\note TreeLoader3D is derived from PageLoader - this implementation provides you with an easy way<br></td></tr
><tr
...
><td class="source">To add trees, just call TreeLoader3D::addTree(), supplying the appropriate parameters. You may notice that<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_35

 onmouseover="gutterOver(35)"

><td class="source">TreeLoader3D restricts trees to uniform scale and yaw rotation. This is done to conserve memory; TreeLoader3D<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_36

 onmouseover="gutterOver(36)"

><td class="source">packs trees into memory as effeciently as possible, taking only 10 bytes per tree. This means 1 million trees<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_37

 onmouseover="gutterOver(37)"

><td class="source">takes 9.53 MB of RAM (additionally, adding 1 million trees takes less than a second in a release build).<br></td></tr
><tr
...
><td class="source">\note Using TreeLoader2D uses 40% less memory than TreeLoader3D.<br></td></tr
><tr
...
><td class="source">class TreeLoader3D: public PageLoader<br></td></tr
><tr
...
><td class="source">	/** \brief Creates a new TreeLoader3D object.<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_45

 onmouseover="gutterOver(45)"

><td class="source">	\param geom The PagedGeometry object that this TreeLoader3D will be assigned to.<br></td></tr
><tr
...
><td class="source">	TreeLoader3D(PagedGeometry *geom, const TBounds &amp;bounds);<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_48

 onmouseover="gutterOver(48)"

><td class="source">	~TreeLoader3D();<br></td></tr
><tr
...
><td class="source">	While TreeLoader3D allows you to provide full 3-dimensional x/y/z coordinates,<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_57

 onmouseover="gutterOver(57)"

><td class="source">	you are restricted to only yaw rotation, and only uniform scale. <br></td></tr
><tr
...
><td class="source">		deleteTrees(const Ogre::Vector3 &amp;position, Ogre::Real radius, Ogre::Entity *type = NULL);<br></td></tr
><tr
...
><td class="source">	The returned TreeIterator3D can be used to iterate through every tree that was added<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_105

 onmouseover="gutterOver(105)"

><td class="source">	to this TreeLoader3D fairly efficiently.<br></td></tr
><tr
...
><td class="source">	TreeIterator3D getTrees();<br></td></tr
><tr
...
><td class="source">	You can use this function to access the internal color map object used by the TreeLoader3D.<br></td></tr
><tr
...
><td class="source">		float yPos;<br></td></tr
><tr
...
><td class="source">	TreeIterator3D(TreeLoader3D *trees);<br></td></tr
><tr
...
><td class="source">	TreeLoader3D *trees;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_335

 onmouseover="gutterOver(335)"

><td class="source">	TreeLoader3D::PageGridListIterator currentGrid;<br></td></tr
><tr
...
><td class="source">	std::vector&lt;TreeLoader3D::TreeDef&gt; *currentTreeList;<br></td></tr
><tr
id=sl_svn06de7ef9f7907b57123b0e03476e547a1db6ae08_338

 onmouseover="gutterOver(338)"

><td class="source">	std::vector&lt;TreeLoader3D::TreeDef&gt;::iterator currentTree;<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 by m2codeGEN (SVA)
 on May 25, 2011
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=8bbc960029af74335b963770a933d78e564a859d&amp;format=side&amp;path=/include/TreeLoader3D.h&amp;old_path=/include/TreeLoader3D.h&amp;old=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef">Diff</a>
 </div>
 ...
 var selected_path = '/include/TreeLoader3D.h';
 ...
 by rortom
 on Apr 9, 2010
 &nbsp; <a href="/p/ogre-paged/source/diff?spec=svn06de7ef9f7907b57123b0e03476e547a1db6ae08&r=39f8aaf4be3c0602d85bd3fda0f99008c2ef1bef&amp;format=side&amp;path=/include/TreeLoader3D.h&amp;old_path=/include/TreeLoader3D.h&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">added svn files</pre>
 </div>
 
 
 <a href="/p/ogre-paged/source/list?path=/include/TreeLoader3D.h&r=8bbc960029af74335b963770a933d78e564a859d">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 13906 bytes,
 346 lines</div>
 
 <div><a href="//ogre-paged.googlecode.com/hg/include/TreeLoader3D.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn06de7ef9f7907b57123b0e03476e547a1db6ae08': '/include/TreeLoader3D.h'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail":"GeoffTopping@gmail.com","relativeBaseUrl":"","projectName":"ogre-paged","domainName":null,"assetHostPath":"http://www.gstatic.com/codesite/ph","assetVersionPath":"http://www.gstatic.com/codesite/ph/15170358673760952803","profileUrl":"/u/107319084838887332900/","projectHomeUrl":"/p/ogre-paged","token":"zBAMHCTMAmvRUxKpxSm1oCJIn5k:1365060186784"}, '', 'svn06de7ef9f7907b57123b0e03476e547a1db6ae08', paths,
