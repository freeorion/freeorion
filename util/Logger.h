...
/** \file
    ...
    a_threshold is written LogLevel::error, etc. Use "" for the name of the unnamed source.
    ...
    These functions are used to provide further options for setting logger thresholds using
    OptionsDB in LoggerWithOptionsDB.<h/cpp>, through the UI in the OptionsWnd.<h/cpp> and from
    the command line in each applications main() functions.
*/
