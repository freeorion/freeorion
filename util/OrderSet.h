...
public:
   ...
   /** \name Mutators */ //@{
   /** stores an order in the OrderSet; returns an index that can be used to reference the order.  \warning The 
      OrderSet assumes that the Order is allocated on the heap, and takes ownership of it.  Do not delete any 
