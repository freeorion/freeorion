...
[[nodiscard]] SitRepEntry CreateShipBuiltSitRep(UniverseObjectID ship_id, UniverseObjectID system_id, int shipdesign_id, int current_turn);
[[nodiscard]] SitRepEntry CreateShipBlockBuiltSitRep(UniverseObjectID system_id, int shipdesign_id, int number, int current_turn);
[[nodiscard]] SitRepEntry CreateBuildingBuiltSitRep(UniverseObjectID building_id, UniverseObjectID planet_id, int current_turn);
...
[[nodiscard]] FO_COMMON_API SitRepEntry CreateCombatSitRep(UniverseObjectID system_id, int log_id, EmpireID empire_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreateGroundCombatSitRep(UniverseObjectID planet_id, EmpireID empire_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetCapturedSitRep(UniverseObjectID planet_id, EmpireID empire_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetRebelledSitRep(UniverseObjectID planet_id, EmpireID empire_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreateCombatDamagedObjectSitRep(
    const UniverseObject* obj, UniverseObjectID combat_system_id, EmpireID empire_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreateCombatDestroyedObjectSitRep(
    const UniverseObject* obj, UniverseObjectID combat_system_id, EmpireID empire_id, int current_turn);
[[nodiscard]] SitRepEntry               CreatePlanetDepopulatedSitRep(UniverseObjectID planet_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetAnnexedSitRep(UniverseObjectID planet_id, EmpireID original_owner_id, EmpireID annexer_empire_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetColonizedSitRep(UniverseObjectID planet_id, std::string species, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetOutpostedSitRep(UniverseObjectID planet_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetEstablishFailedSitRep(UniverseObjectID planet_id, UniverseObjectID ship_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetEstablishFailedVisibleOtherSitRep(UniverseObjectID planet_id, UniverseObjectID ship_id, EmpireID other_empire_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetEstablishFailedArmedSitRep(UniverseObjectID planet_id, UniverseObjectID ship_id, EmpireID other_empire_id, int current_turn);

[[nodiscard]] FO_COMMON_API SitRepEntry CreatePlanetGiftedSitRep(UniverseObjectID planet_id, EmpireID empire_id, int current_turn);
[[nodiscard]] FO_COMMON_API SitRepEntry CreateFleetGiftedSitRep(UniverseObjectID fleet_id, EmpireID empire_id, int current_turn);

[[nodiscard]] FO_COMMON_API SitRepEntry CreateFleetArrivedAtDestinationSitRep(
    UniverseObjectID system_id, UniverseObjectID fleet_id, EmpireID recipient_empire_id, const ScriptingContext& context);
[[nodiscard]] FO_COMMON_API SitRepEntry CreateFleetBlockadedSitRep(
    UniverseObjectID system_id, UniverseObjectID blockaded_fleet_id, EmpireID blockaded_empire_id,
    EmpireID blockading_empire_id, const ScriptingContext& context);
[[nodiscard]] FO_COMMON_API SitRepEntry CreateFleetBlockadedSitRep(
    UniverseObjectID system_id, UniverseObjectID blockaded_fleet_id, EmpireID blockaded_empire_id, const ScriptingContext& context);

[[nodiscard]] SitRepEntry               CreateEmpireEliminatedSitRep(EmpireID empire_id, int current_turn);
[[nodiscard]] SitRepEntry               CreateVictorySitRep(std::string reason_string, EmpireID empire_id, int current_turn);
