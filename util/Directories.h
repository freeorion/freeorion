...
/** This function returns the directory where FreeOrion should store user
  * specific data, like the configuration file and savegames.  Under Unix, this
  * would be <tt>~/.freeorion</tt>, under Windows, this might be something
...
/** This function returns the root data directory of FreeOrion. Under Windows,
  * it is the directory where FreeOrion is installed, under Linux, this can be
...
/** This function returns the directory where the binaries are located. Under
