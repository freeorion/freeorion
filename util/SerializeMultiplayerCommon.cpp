...
template void CombatData::save<freeorion_bin_oarchive>(freeorion_bin_oarchive&, const unsigned int) const;
template void CombatData::load<freeorion_bin_iarchive>(freeorion_bin_iarchive&, const unsigned int);
template void CombatData::save<freeorion_xml_oarchive>(freeorion_xml_oarchive&, const unsigned int) const;
template void CombatData::load<freeorion_xml_iarchive>(freeorion_xml_iarchive&, const unsigned int);
...
template void CombatSetupRegion::serialize<freeorion_bin_oarchive>(freeorion_bin_oarchive&, const unsigned int);
template void CombatSetupRegion::serialize<freeorion_bin_iarchive>(freeorion_bin_iarchive&, const unsigned int);
template void CombatSetupRegion::serialize<freeorion_xml_oarchive>(freeorion_xml_oarchive&, const unsigned int);
template void CombatSetupRegion::serialize<freeorion_xml_iarchive>(freeorion_xml_iarchive&, const unsigned int);
...
template void CombatSetupGroup::serialize<freeorion_bin_oarchive>(freeorion_bin_oarchive&, const unsigned int);
template void CombatSetupGroup::serialize<freeorion_bin_iarchive>(freeorion_bin_iarchive&, const unsigned int);
template void CombatSetupGroup::serialize<freeorion_xml_oarchive>(freeorion_xml_oarchive&, const unsigned int);
template void CombatSetupGroup::serialize<freeorion_xml_iarchive>(freeorion_xml_iarchive&, const unsigned int);
