...
public:
    ...
    [[nodiscard]] const std::vector<int>&        ObjectIDs() const;                      ///< returns UniverseObject IDs in this ResourcePool
    [[nodiscard]] float                          Stockpile() const;                      ///< returns current stockpiled amount of resource

    [[nodiscard]] float                                 TotalOutput() const;             ///< returns amount of resource being generated by all ResourceCenters
    [[nodiscard]] const std::map<std::set<int>, float>& Output() const;                  ///< returns the sets of groups of objects that can share resources, and the amount of this pool's resource that each group is generating this turn
    ...
    [[nodiscard]] float                          TotalAvailable() const;                 ///< returns amount of resource immediately available = output + stockpile from all ResourceCenters, ignoring limitations of connections between centers
    ...
    [[nodiscard]] std::map<std::set<int>, float> Available() const;
